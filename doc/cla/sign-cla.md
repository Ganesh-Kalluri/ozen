# Sign the Leewise CLA

In order for your contribution to Leewise to be accepted, you have to sign the
Leewise Contributor License Agreement (CLA). More information about this
...
2.  Modify your current pull request, or make a new pull request on
    [leewise/leewise](https://github.com/leewise/leewise), adding a new file
...
3. An Leewise R&D Team member will verify and accept your Pull Request. You can
...
2.  Modify your current pull request, or make a new pull request on
    [leewise/leewise](/leewise/leewise), adding a new file `<lowercase-company-name>.md`
    under the [`doc/cla/corporate`](corporate/) directory.
    If the name of the company is Leewise, the file would be
    `doc/cla/corporate/leewise.md`. The file should contain:

```
<country>, <date>

<company-name> agrees to the terms of the Leewise Corporate Contributor License
Agreement v1.0.
...
`cla-submission` `at` `leewise.com`.  In that case someone from the Leewise team will
make the pull request on your behalf.

* Printable Leewise CCLA v1.0 https://www.leewise.in/files/legal/Leewise-CCLA-v1.0.pdf
* Printable Leewise ICLA v1.0 https://www.leewise.in/files/legal/Leewise-ICLA-v1.0.pdf

# FAQ

## Why do I need to accept a CLA ?

The goal of having a Contributor License Agreement for Leewise is to:

* clearly define the terms under which intellectual property (patches, pull
  requests, etc.) have been contributed to the Leewise project

* protect the Leewise project and its users in case of legal dispute about the
  origin or ownership of any part of the code

* protect the Leewise project and its users from bad actors who would contribute
...
contributor really intended to contribute to the Leewise project under specific
...
The Leewise CLA is based on the Apache Software Foundation CLA v2.0, as
...
irrevocable license to the project maintainer, Leewise to use, modify and
...
(ICLA) of Leewise.  The agreement is executed by adding your name and
...
removed from the Leewise project.
