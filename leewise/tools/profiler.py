...
class SyncCollector(Collector):
    ...
    Note that --limit-memory-hard may need to be increased when launching Leewise.
    """
    name = 'traces_sync'
    ...
    def __exit__(self, *args):
        try:
            ...
            if self.db:
                ...
                from leewise.sql_db import db_connect  # only import from leewise if/when needed.
