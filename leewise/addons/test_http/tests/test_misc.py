...
class TestHttpMisc(TestHttpBase):
    ...
    def test_misc3_is_static_file(self):
        ...
        self.assertEqual(root.get_static_file(f'leewise.com/{uri}', host='leewise.com'), path, "Valid file with valid host")
        self.assertEqual(root.get_static_file(f'http://leewise.com/{uri}', host='leewise.com'), path, "Valid file with valid host")
        ...
        self.assertIsNone(root.get_static_file(f'leewise.com/{uri}'), "No host allowed")
        self.assertIsNone(root.get_static_file(f'http://leewise.com/{uri}'), "No host allowed")
