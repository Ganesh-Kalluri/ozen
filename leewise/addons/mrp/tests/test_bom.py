...
from leewise import exceptions, Command, fields
from leewise.tests import Form
from leewise.addons.mrp.tests.common import TestMrpCommon
from leewise.tools import float_compare, float_round, float_repr
...
class TestBoM(TestMrpCommon):
    ...
    def test_cycle_on_bom_sequencing(self):
        ...
        # (see leewise/addons/web/controllers/main.py:1352)
