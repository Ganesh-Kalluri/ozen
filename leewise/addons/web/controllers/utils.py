...
from leewise.tools.translate import JAVASCRIPT_TRANSLATION_COMMENT, WEB_TRANSLATION_COMMENT
...
def fix_view_modes(action):
    """ For historical reasons, Leewise has weird dealings in relation to
