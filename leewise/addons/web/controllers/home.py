...
from leewise.tools import ustr
...
class Home(http.Controller):
    ...
    def web_login(self, redirect=None, **kw):
        ...
        if request.httprequest.method == 'POST':
            ...
            except leewise.exceptions.AccessDenied as e:
                if e.args == leewise.exceptions.AccessDenied().args:
    ...
    def switch_to_admin(self):
        ...
        if request.env.user._is_system():
            uid = request.session.uid = leewise.SUPERUSER_ID
