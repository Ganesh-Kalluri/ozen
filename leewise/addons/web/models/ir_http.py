...
from leewise.http import request, DEFAULT_MAX_CONTENT_LENGTH
from leewise.tools import ormcache, ustr
...
class Http(models.AbstractModel):
    ...
    def session_info(self):
        ...
        version_info = leewise.service.common.exp_version()
        ...
        session_info = {
            ...
            "support_url": "https://www.leewise.in/buy",
            "name": user.name,
            "username": user.login,
