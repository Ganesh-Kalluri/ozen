...
import { Component, xml, onWillStart, App } from "@leewise/owl";
...
assets.loadBundle = async function loadBundle(desc) {
    ...
    leewise.loader.checkAndReportErrors();
};
 ...
 */
export const templates = new DOMParser().parseFromString("<leewise/>", "text/xml");
/**
