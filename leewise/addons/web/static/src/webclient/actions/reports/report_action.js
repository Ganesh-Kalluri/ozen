...
import { Component, useRef, useSubEnv } from "@leewise/owl";
 ...
 * It uses a feature to automatically create links to other leewise pages if the selector [res-id][res-model][view-type]
 * is detected.
 */
