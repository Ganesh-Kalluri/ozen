 ...
 */
function setup() {
    env = leewise.__WOWL_DEBUG__.root.env;
    ...
    menuIndex = 0;
    subMenuIndex = 0;
    isEnterprise = leewise.info && leewise.info.isEnterprise;
}
...
async function _clickEverywhere(xmlId) {
    ...
    console.log(`Leewise flavor: ${isEnterprise ? "Enterprise" : "Community"}`);
