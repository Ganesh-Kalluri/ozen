...
function LeewiseEvent(target, name, data) {
    this.target = target;
    this.name = name;
...
LeewiseEvent.prototype.stopPropagation = function () {
    this.stopped = true;
};

LeewiseEvent.prototype.is_stopped = function () {
    return this.stopped;
};
...
var EventDispatcherMixin = Object.assign({}, ParentedMixin, {
    ...
    trigger_up: function (name, info) {
        var event = new LeewiseEvent(this, name, info);
