...
import { Component, whenReady } from "@leewise/owl";
...
export async function startWebClient(Webclient) {
    ...
    await whenReady();
    const app = await mountComponent(Webclient, document.body, { name: "Leewise Web Client" });
    const { env } = app;
    Component.env = env;
    ...
    // delete leewise.debug; // FIXME: some legacy code rely on this
