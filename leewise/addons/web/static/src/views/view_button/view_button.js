...
const leewiseToBootstrapClasses = {
...
export class ViewButton extends Component {
    ...
    get hasBigTooltip() {
        return Boolean(leewise.debug) || this.clickParams.help;
    }
    ...
    getClassName() {
        ...
        if (this.props.className) {
            for (let cls of this.props.className.split(" ")) {
                if (cls in leewiseToBootstrapClasses) {
                    cls = leewiseToBootstrapClasses[cls];
                }
                classNames.push(cls);
