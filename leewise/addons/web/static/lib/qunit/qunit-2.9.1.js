...
(function (global$1) {
  ...
  SUPPORTED_EVENTS.push("LeewiseBeforeTestHook", "LeewiseAfterTestHook"); // Leewise customization
  ...
  Test.prototype = {
  	...
  	before: function before() {
  		...
  		return callbackPromises.then(function () {
			...
			emit("LeewiseBeforeTestHook"); // Leewise customization
  	...
  	finish: async function finish() {
  		...
  		emit("LeewiseAfterTestHook", this);
