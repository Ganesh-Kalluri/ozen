...
import { Component, useRef, useState, xml } from "@leewise/owl";
...
QUnit.test("hotkey handles wrongly formed KeyboardEvent", async (assert) => {
    ...
    // fake error service so that the leewise qunit handlers don't think that they need to handle the error
