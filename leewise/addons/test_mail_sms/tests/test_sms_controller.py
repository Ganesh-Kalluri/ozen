...
from leewise.addons.test_mail_sms.tests.test_sms_management import TestSMSActionsCommon
from leewise.tests.common import HttpCase, JsonRpcException
...
class TestSmsController(HttpCase, TestSMSActionsCommon):
    ...
    @mute_logger("leewise.addons.base.models.ir_http")
    ...
    @mute_logger('leewise.addons.base.models.ir_http', 'leewise.addons.sms.controllers.main', 'leewise.http')
