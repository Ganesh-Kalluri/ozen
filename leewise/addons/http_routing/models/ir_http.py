...
import leewise
from leewise import api, models, exceptions, tools, http
from leewise.addons.base.models import ir_http
from leewise.addons.base.models.ir_http import RequestUID
from leewise.addons.base.models.ir_qweb import QWebException
from leewise.http import request, HTTPRequest, Response
from leewise.osv import expression
from leewise.tools import config, ustr, pycompat
    ...
    def _pre_dispatch(cls, rule, args):
        ...
        if request.is_frontend_multilang:
            ...
            if request.httprequest.method in ('GET', 'HEAD'):
                ...
                except leewise.exceptions.MissingError:
