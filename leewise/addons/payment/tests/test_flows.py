...
from leewise.addons.payment.controllers.portal import PaymentPortal
...
class TestFlows(PaymentHttpCommon):
    ...
    def test_transaction_wrong_flow(self):
        ...
        with mute_logger("leewise.http"), self.assertRaises(
            JsonRpcException,
            msg='leewise.exceptions.UserError: The payment should either be direct, with redirection, or made by a token.',
        ):
    ...
    def test_transaction_wrong_token(self):
        ...
        with mute_logger('leewise.http'), self.assertRaises(JsonRpcException, msg='leewise.exceptions.ValidationError: The access token is invalid.'):
    ...
    @mute_logger('leewise.addons.payment.models.payment_transaction')
