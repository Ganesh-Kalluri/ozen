...
from leewise import fields, models, api, _, Command
from leewise.exceptions import UserError
from leewise.tools import float_repr, date_utils
from leewise.tools.xml_utils import cleanup_xml_node, find_xml_value
...
class AccountMove(models.Model):
    ...
    def _search_product_for_import(self, item_description):
        # Exported Leewise XML will have item_description = "[default_code] name".
