...
from leewise.addons.l10n_ec_edi.models.account_move import L10N_EC_VAT_SUBTAXES
from leewise.addons.l10n_ec_edi.models.ir_attachment import L10N_EC_XSD_INFOS
from leewise.exceptions import UserError
from leewise.tools import DEFAULT_SERVER_DATETIME_FORMAT as DTF
from leewise.tools import float_repr, float_round, html_escape
