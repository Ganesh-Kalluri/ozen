/** @leewise-module **/
/* global LeewiseDeviceUtility */

import { uniqueId } from "@web/core/utils/functions";
import { browser } from "@web/core/browser/browser";
import { parseHash } from "@web/core/browser/router_service";

var available = typeof LeewiseDeviceUtility !== 'undefined';
var DeviceUtility;
var deferreds = {};
export var methods = {};

if (available){
    DeviceUtility = LeewiseDeviceUtility;
    delete window.LeewiseDeviceUtility;
}
 ...
 * @param {Object} result
 */
window.leewise.native_notify = function (id, result) {
