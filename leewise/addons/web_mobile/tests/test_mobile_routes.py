...
from leewise.tests.common import HttpCase, tagged, get_db_name
...
class MobileRoutesTest(HttpCaseWithUserDemo):
    ...
    def test_version_info(self):
        """
        This request is used to check for a compatible Leewise server
        """
    ...
    def test_database_list(self):
        ...
        if config['list_db']:
            ...
            self.assertEqual(error["message"], "Leewise Server Error")
            self.assertEqual(error["data"]["name"], "leewise.exceptions.AccessDenied")
    ...
    def test_authenticate_wrong_database(self):
        ...
        self.assertEqual(error["code"], 200)
        self.assertEqual(error["message"], "Leewise Server Error")
        self.assertEqual(error["data"]["name"], "leewise.exceptions.AccessError")
