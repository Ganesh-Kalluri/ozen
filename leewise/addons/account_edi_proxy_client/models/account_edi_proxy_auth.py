...
class LeewiseEdiProxyAuth(requests.auth.AuthBase):
    ...
    def __call__(self, request):
        ...
        request.headers.update({
            'leewise-edi-client-id': self.id_client,
            'leewise-edi-signature': h.hexdigest(),
            'leewise-edi-timestamp': msg_timestamp,
        })
        return request
