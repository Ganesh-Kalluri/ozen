...
from leewise import models, fields, api, _, _lt
...
ERROR_CODE_TO_MSG = {
    ...
    'unknown_deposit': _lt("This deposit is unknown from Leewise."),
    'unknown_declaration': _lt("This declaration is unknown from Leewise."),
    ...
    'not_enterprise': _lt("You do not have an Leewise enterprise subscription."),
