...
function initialize_map() {
    ...
    var map = new google.maps.Map(document.getElementById('leewise-google-map'), {
        zoom: 1,
    ...
    if (leewise_partner_data){ /* leewise_partner_data special variable should have been defined in google_map.xml */
        for (var i = 0; i < leewise_partner_data.counter; i++) {
            set_marker(leewise_partner_data.partners[i]);
        }
