...
from leewise.exceptions import UserError, AccessDenied
from leewise.tools import float_is_zero, pycompat
...
class AccountFrFec(models.TransientModel):
    ...
    def generate_fec(self):
        ...
        # but Leewise has the label on the account.move.line, so that's a
        # problem !
