...
from leewise import SUPERUSER_ID, _, api, fields, models, registry
from leewise.exceptions import UserError, ValidationError
from leewise.osv import expression
from leewise.tools import float_compare, float_is_zero, html_escape
from leewise.tools.misc import split_every
...
class StockRule(models.Model):
    ...
    def _get_lead_days(self, product, **values):
        ...
        :type product: :class:`~leewise.addons.product.models.product.ProductProduct`
...
class ProcurementGroup(models.Model):
    ...
    def run(self, procurements, raise_user_error=True):
        ...
        :type list: list of `~leewise.addons.stock.models.stock_rule.ProcurementGroup.Procurement`
