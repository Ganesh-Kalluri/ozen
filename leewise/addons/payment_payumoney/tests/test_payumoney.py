...
from leewise.addons.payment_payumoney.controllers.main import PayUMoneyController
from leewise.addons.payment_payumoney.tests.common import PayumoneyCommon
...
class PayUMoneyTest(PayumoneyCommon, PaymentHttpCommon):
    ...
    @mute_logger('leewise.addons.payment_payumoney.controllers.main')
