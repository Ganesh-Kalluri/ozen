...
from leewise.tools import format_amount, format_date
from leewise.exceptions import AccessError, MissingError, UserError
...
class OnlineSynchronizationPortal(CustomerPortal):
    ...
    def portal_online_sync_renew_consent(self, journal_id, access_token=None, **kw):
        ...
        # Requires the same rights as the button in leewise.
        try:
