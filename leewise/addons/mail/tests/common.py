...
from leewise.addons.base.models.ir_mail_server import IrMailServer
from leewise.addons.base.tests.common import MockSmtplibCase
from leewise.addons.bus.models.bus import ImBus, json_dump
from leewise.addons.mail.models.mail_mail import MailMail
from leewise.addons.mail.models.mail_message import Message
from leewise.addons.mail.models.mail_notification import MailNotification
from leewise.addons.mail.models.res_users import Users
from leewise.tests import common, new_test_user
from leewise.tools import email_normalize, formataddr, mute_logger, pycompat
from leewise.tools.translate import code_translations
...
class MailCommon(common.TransactionCase, MailCase):
    ...
    def _activate_multi_lang(cls, lang_code='es_ES', layout_arch_db=None, test_record=False, test_template=False):
        ...
        with mute_logger("leewise.addons.base.models.ir_module", "leewise.tools.translate"):
