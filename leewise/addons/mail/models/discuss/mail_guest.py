...
import leewise
from leewise.tools import consteq, get_lang
...
from leewise.addons.bus.models.bus_presence import AWAY_TIMER, DISCONNECTION_TIMER
from leewise.addons.bus.websocket import wsrequest
...
class MailGuest(models.Model):
    ...
    def _init_messaging(self):
        self.ensure_one()
        # sudo: res.partner - exposing LeewiseBot name and id
        leewisebot = self.env.ref('base.partner_root').sudo()
    ...
    def _guest_format(self, fields=None):
        ...
        for guest in self:
            ...
            if "write_date" in fields:
                data["write_date"] = leewise.fields.Datetime.to_string(guest.write_date)
            data['type'] = "guest"
