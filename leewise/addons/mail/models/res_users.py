...
from leewise import _, api, Command, fields, models, modules, tools
...
class Users(models.Model):
    ...
    def _init_messaging(self):
        ...
        values = {
            ...
            'leewisebot': leewisebot.sudo().mail_partner_format().get(leewisebot),
