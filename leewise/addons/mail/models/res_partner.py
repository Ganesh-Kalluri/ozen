...
class Partner(models.Model):
    ...
    def _compute_im_status(self):
        ...
        leewisebot = self.env['res.partner'].browse(leewisebot_id)
        if leewisebot in self:
            leewisebot.im_status = 'bot'
    ...
    def mail_partner_format(self, fields=None):
        ...
        for partner in self:
            ...
            if "write_date" in fields:
                data["write_date"] = leewise.fields.Datetime.to_string(partner.write_date)
            if 'user' in fields:
