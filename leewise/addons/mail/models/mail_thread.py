...
from leewise import _, api, exceptions, fields, models, tools, registry, SUPERUSER_ID, Command
from leewise.exceptions import MissingError, AccessError
from leewise.osv import expression
from leewise.tools import is_html_empty, html_escape, html2plaintext, parse_contact_from_email
from leewise.tools.misc import clean_context, split_every
...
class MailThread(models.AbstractModel):
    ...
    def _message_route_process(self, message, message_dict, routes):
        ...
        for model, thread_id, custom_values, user_id, alias in routes or ():
            ...
            # switch to leewisebot for all incoming message creation
            ...
            if thread_root._name == 'mail.thread':  # message with parent_id not linked to record
                ...
                # parsing should find an author independently of user running mail gateway, and ensure it is not leewisebot
    ...
    def _notify_by_email_get_base_mail_values(self, message, additional_values=None):
        ...
        # SES SMTP may replace Message-Id and In-Reply-To refers an internal ID not stored in Leewise)
    ...
    def _extract_partner_ids_for_notifications(self, message, msg_vals, recipients_data):
        ...
        # never send to author and to people outside Leewise (email), except comments
        pids = set()
        if msg_type == 'comment':
    ...
    def _notify_by_web_push_prepare_payload(self, message, msg_vals=False):
        ...
        icon = '/web/static/img/leewise-icon-192x192.png'
