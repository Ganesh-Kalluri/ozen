...
from leewise import _, api, fields, models, tools, Command
...
from leewise.addons.mail.tools.parser import parse_res_ids
...
class MailComposer(models.TransientModel):
    ...
    auto_delete = fields.Boolean(
        ...
        help='This option permanently removes any track of email after it\'s been sent, including from the Technical menu in the Settings, in order to preserve storage space of your Leewise database.')
    ...
    def _evaluate_res_domain(self):
        ...
        :return: an Leewise domain (list of leaves) """
        self.ensure_one()
