...
import { reactive } from "@leewise/owl";
...
/**
 * @return {Promise<{ SfuClient: import("@mail/static/libs/leewise_sfu/leewise_sfu").SfuClient, SFU_CLIENT_STATE: import("@mail/static/libs/leewise_sfu/leewise_sfu").SFU_CLIENT_STATE }>}
 */
const loadSfuAssets = memoize(async () => await loadBundle("mail.assets_leewise_sfu"));
...
export class Rtc {
    ...
    /** @type {import("@mail/static/libs/leewise_sfu/leewise_sfu").SfuClient} */
    sfuClient = undefined;
    ...
    async loadSfuClient() {
        ...
        try {
            await loadSfuAssets();
            const sfuModule = leewise.loader.modules.get("@mail/../lib/leewise_sfu/leewise_sfu");
