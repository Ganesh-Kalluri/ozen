    ...
    setup() {
        ...
        this.env.bus.addEventListener(
            ...
            ({ detail: { channel, message } }) => {
                ...
                if (channel.correspondent?.eq(this.store.leewisebot) && this.store.leewisebotOnboarding) {
                    // this cancels leewisebot onboarding auto-opening of chat window
                    this.store.leewisebotOnboarding = false;
                    return;
                }
