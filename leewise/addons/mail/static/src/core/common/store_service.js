...
export class Store extends BaseStore {
    ...
    inPublicPage = false;
    companyName = "";
    leewisebot = Record.one("Persona");
    leewisebotOnboarding;
    users = {};
    ...
    menuThreads = Record.many("Thread", {
        ...
        sort(a, b) {
             ...
             */
            const aLeewiseBot = a.isCorrespondentLeewiseBot;
            const bLeewiseBot = b.isCorrespondentLeewiseBot;
            if (aLeewiseBot && !bLeewiseBot) {
                return 1;
            }
            if (bLeewiseBot && !aLeewiseBot) {
                return -1;
            }
