...
import { Component, useState } from "@leewise/owl";
...
export class MessagingMenu extends Component {
    ...
    get installationRequest() {
        return {
            body: _t("Come here often? Install Leewise on your device!"),
            displayName: _t("%s has a suggestion", this.store.leewisebot.name),
            onClick: () => {
                this.installPrompt.show();
            },
            iconSrc: this.threadService.avatarUrl(this.store.leewisebot),
            partner: this.store.leewisebot,
    ...
    get notificationRequest() {
        return {
            ...
            displayName: _t("%s has a request", this.store.leewisebot.name),
            iconSrc: this.threadService.avatarUrl(this.store.leewisebot),
            partner: this.store.leewisebot,
            isShown:
                this.store.discuss.activeTab === "main" &&
