...
Communicate with your colleagues/customers/guest within Leewise.
...
from Leewise itself, and that too with great possibilities. For example,
...
these accounts will be automatically downloaded into your Leewise system. All
POP3/IMAP-compatible servers are supported, included those that require an
encrypted SSL/TLS connection.
This can be used to easily create email-based workflows for many email-enabled Leewise documents, such as:
----------------------------------------------------------------------------------------------------------
...
mailbox-to-Leewise integration. Even better: these documents directly act as mini
conversations synchronized by email. You can reply from within Leewise, and the
...
(technically: Server Actions) to be triggered for each incoming mail.
    ...
    'assets': {
        ...
        'web.assets_backend': [
            ...
            'mail/static/lib/**/*',
            ('remove', 'mail/static/lib/leewise_sfu/leewise_sfu.js'),
        ...
        'mail.assets_leewise_sfu': [
            'mail/static/lib/leewise_sfu/leewise_sfu.js',
        ],
        'mail.assets_lamejs': [
        ...
        'mail.assets_public': [
            ...
            'web/static/lib/leewise_ui_icons/style.css',
