...
from leewise.addons.iap import InsufficientCreditError
from leewise.addons.l10n_br_edi.tests.data_invoice_1 import (
    invoice_1_request,
...
from leewise.tools import json
...
class TestL10nBREDI(AccountTestInvoicingCommon):
    ...
    def test_invoice_1_iap_errors(self):
        ...
        def wrap_iap(exception):
            ...
            with patch(
                "leewise.addons.l10n_br_avatax.models.account_external_tax_mixin.iap_jsonrpc", side_effect=exception
