...
class TestMailingControllers(TestMailingControllersCommon):
    ...
    @mute_logger('leewise.http', 'leewise.addons.website.models.ir_ui_view')
...
class TestMailingTracking(TestMailingControllersCommon):
    ...
    @mute_logger('leewise.addons.mail.models.mail_mail', 'leewise.addons.mass_mailing.models.mailing')
