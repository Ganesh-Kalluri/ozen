...
class TestLeewisebot(MailCommon, TestRecipients):
    ...
    def setUpClass(cls):
        ...
        cls.leewisebot_ping_body = '<a href="http://leewise.com/web#model=res.partner&amp;id=%s" class="o_mail_redirect" data-oe-id="%s" data-oe-model="res.partner" target="_blank">@LeewiseBot</a>' % (cls.leewisebot.id, cls.leewisebot.id)
