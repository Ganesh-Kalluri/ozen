...
try:
    ...
    from leewise.addons.social_facebook.models.social_live_post import SocialLivePostFacebook
    from leewise.addons.social_facebook.models.social_stream import SocialStreamFacebook
    is_facebook_module_installed = True
except ImportError:
    is_facebook_module_installed = False

try:
    from leewise.addons.social_instagram.models.social_account import SocialAccountInstagram
    from leewise.addons.social_instagram.models.social_live_post import SocialLivePostInstagram
    from leewise.addons.social_instagram.models.social_post import SocialPostInstagram
    from leewise.addons.social_instagram.models.social_stream import SocialStreamInstagram
    is_instagram_module_installed = True
except ImportError:
    is_instagram_module_installed = False

try:
    from leewise.addons.social_linkedin.models.social_account import SocialAccountLinkedin
    from leewise.addons.social_linkedin.models.social_live_post import SocialLivePostLinkedin
    from leewise.addons.social_linkedin.models.social_stream import SocialStreamLinkedIn
    is_linkedin_module_installed = True
except ImportError:
    is_linkedin_module_installed = False

try:
    from leewise.addons.social_twitter.models.social_account import SocialAccountTwitter
    from leewise.addons.social_twitter.models.social_live_post import SocialLivePostTwitter
    from leewise.addons.social_twitter.models.social_stream import SocialStreamTwitter
    is_twitter_module_installed = True
except ImportError:
    is_twitter_module_installed = False

try:
    from leewise.addons.social_youtube.models.social_account import SocialAccountYoutube
    from leewise.addons.social_youtube.models.social_live_post import SocialLivePostYoutube
    from leewise.addons.social_youtube.models.social_stream import SocialStreamYoutube
