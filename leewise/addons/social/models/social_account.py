...
from leewise import _, models, fields, api
...
class SocialAccount(models.Model):
    ...
    social_account_handle = fields.Char("Handle / Short Name",
        help="Contains the social media handle of the person that created this account. E.g: '@leewise.official' for the 'Leewise' Twitter account")
    ...
    def _compute_stats_link(self):
        ...
        Ex: https://www.facebook.com/Leewise-Social-557894618055440/insights """
        for account in self:
            account.stats_link = False

    @api.depends('media_id')
    def _compute_display_name(self):
        """ ex: [Facebook] Leewise Social, [Twitter] Mitchell Admin, ... """
        for account in self:
