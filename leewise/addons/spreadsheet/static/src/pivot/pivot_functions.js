...
const LEEWISE_PIVOT_HEADER = {
    ...
    compute: function (pivotId, ...domain) {
        ...
        return this.getters.computeLeewisePivotHeaderValue(pivotId, domainArgs);
    },
...
function getPivotCellValueAndFormat(pivotId, pivotCell) {
    if (!pivotCell.domain) {
        ...
        const fn = pivotCell.isHeader ? LEEWISE_PIVOT_HEADER : LEEWISE_PIVOT;
...
functionRegistry
    .add("LEEWISE.FILTER.VALUE", LEEWISE_FILTER_VALUE)
    .add("LEEWISE.PIVOT", LEEWISE_PIVOT)
    .add("LEEWISE.PIVOT.HEADER", LEEWISE_PIVOT_HEADER)
    .add("LEEWISE.PIVOT.POSITION", LEEWISE_PIVOT_POSITION)
    .add("LEEWISE.PIVOT.TABLE", LEEWISE_PIVOT_TABLE);
