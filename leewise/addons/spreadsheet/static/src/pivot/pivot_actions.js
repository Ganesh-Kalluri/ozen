 ...
 * pivot domain args.
 * e.g. =LEEWISE.PIVOT("1", "measure", "country_id", 1) matches a filter on
 * country_id.
 *
 * @returns {boolean}
 */
export function SET_FILTER_MATCHING_CONDITION(position, env) {
    ...
    return (
        ...
        (pivotFunction === "LEEWISE.PIVOT" ||
            pivotFunction === "LEEWISE.PIVOT.HEADER" ||
            pivotFunction === "LEEWISE.PIVOT.TABLE") &&
