...
coreTypes.add("RENAME_LEEWISE_PIVOT");
coreTypes.add("REMOVE_PIVOT");
coreTypes.add("RE_INSERT_PIVOT");
coreTypes.add("UPDATE_LEEWISE_PIVOT_DOMAIN");

invalidateEvaluationCommands.add("UPDATE_LEEWISE_PIVOT_DOMAIN");
invalidateEvaluationCommands.add("REMOVE_PIVOT");
invalidateEvaluationCommands.add("INSERT_PIVOT");
invalidateEvaluationCommands.add("RENAME_LEEWISE_PIVOT");

invalidateDependenciesCommands.add("UPDATE_LEEWISE_PIVOT_DOMAIN");
invalidateDependenciesCommands.add("REMOVE_PIVOT");
invalidateDependenciesCommands.add("INSERT_PIVOT");
invalidateDependenciesCommands.add("RENAME_LEEWISE_PIVOT");

invalidateCFEvaluationCommands.add("UPDATE_LEEWISE_PIVOT_DOMAIN");
invalidateCFEvaluationCommands.add("REMOVE_PIVOT");
invalidateCFEvaluationCommands.add("INSERT_PIVOT");
invalidateCFEvaluationCommands.add("RENAME_LEEWISE_PIVOT");
...
inverseCommandRegistry
    ...
    .add("RENAME_LEEWISE_PIVOT", identity)
    .add("REMOVE_PIVOT", identity)
    .add("UPDATE_LEEWISE_PIVOT_DOMAIN", identity)
