...
export class SpreadsheetPivotModel extends PivotModel {
     ...
     * e.g. in `LEEWISE.PIVOT.HEADER(1, "stage_id", "42", "status", "won")`
     *      the last group value is "won".
     *
     * It can also handle positional arguments.
     * e.g. in `LEEWISE.PIVOT.HEADER(1, "#stage_id", 1, "#user_id", 1)`
     *      the last group value is the id of the first user of the first stage.
     *
     * @param {(string | number)[]} domainArgs LEEWISE.PIVOT.HEADER arguments
     */
    ...
    /**
     * Get the Leewise domain corresponding to the given domain
     */
