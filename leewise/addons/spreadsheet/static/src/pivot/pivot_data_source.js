...
import { LeewiseViewsDataSource } from "../data_sources/leewise_views_data_source";
import { SpreadsheetPivotModel } from "./pivot_model";
import { Domain } from "@web/core/domain";

export class PivotDataSource extends LeewiseViewsDataSource {
    /**
     *
     * @override
     ...
     * - regular function 'LEEWISE.PIVOT.HEADER(1,"stage_id",2,"user_id",6)'
     * - measure header 'LEEWISE.PIVOT.HEADER(1,"stage_id",2,"user_id",6,"measure","expected_revenue")
     * - positional header 'LEEWISE.PIVOT.HEADER(1,"#stage_id",1,"#user_id",1)'
     *
     * @param {(string | number)[]} domainArgs arguments of the function (except the first one which is the pivot id)
     * @returns {string | number}
     */
    computeLeewisePivotHeaderValue(domainArgs) {
