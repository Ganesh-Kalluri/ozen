...
class BadLeewiseLinkError extends EvaluationError {
    constructor(menuId) {
        super(
            _t("#LINK"),
...
export const spreadsheetLinkMenuCellService = {
    ...
    start(env) {
        function _getIrMenuByXmlId(xmlId) {
            ...
            if (!menu) {
                throw new BadLeewiseLinkError(xmlId);
            }
            return menu;
        }

        urlRegistry
            .add("LeewiseMenuIdLink", {
                sequence: 65,
                ...
                createLink(url, label) {
                    ...
                    if (!menu) {
                        throw new BadLeewiseLinkError(menuId);
                    }
                    return {
                        url,
                        label: _t(label),
                ...
                //     return new LeewiseMenuLinkCell(id, content, menuId, menuName, properties);
                // },
            })
            .add("LeewiseMenuXmlLink", {
                sequence: 66,
