...
from leewise.addons.payment_payulatam.controllers.main import PayuLatamController
from leewise.addons.payment_payulatam.tests.common import PayULatamCommon
...
class PayULatamTest(PayULatamCommon, PaymentHttpCommon):
    ...
    @mute_logger('leewise.addons.payment_payulatam.controllers.main')
    ...
    def test_webhook_notification_triggers_signature_check(self):
        ...
        url = self._build_url(PayuLatamController._webhook_url)
        with patch(
            'leewise.addons.payment_payulatam.controllers.main.PayuLatamController'
