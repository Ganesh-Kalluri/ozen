...
from leewise.tests import TransactionCase, tagged, Form
from leewise.addons.delivery_bpost.models.delivery_bpost import TRACKING_REF_DELIM
...
class TestDeliveryBpost(TransactionCase):
    ...
    def setUp(self):
        ...
        self.your_company.write({'name': 'Leewise SA',
        ...
        self.agrolait.write({'name': 'Leewise Brussels',
        ...
        self.think_big_system.write({'name': "Palais de l'Élysee",
                                 ...
                                 'phone': '0142928100'})
        self.leewiseinc = self.env['res.partner'].create({'name': "Leewise Inc.",
                                 'is_company': True,
