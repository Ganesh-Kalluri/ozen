...
from leewise.tools.misc import mute_logger, file_open
from leewise.tools.translate import WEB_TRANSLATION_COMMENT


@leewise.tests.tagged('-at_install', 'post_install')
class TestUi(leewise.tests.HttpCase, SignRequestCommon):
    def test_ui(self):
