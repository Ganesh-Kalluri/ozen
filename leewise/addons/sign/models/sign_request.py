...
from leewise import api, fields, models, http, _, Command
from leewise.tools import config, email_normalize, get_lang, is_html_empty, format_date, formataddr, groupby, consteq
from leewise.exceptions import UserError, ValidationError
from leewise.tools.misc import hmac
...
class SignRequest(models.Model):
    ...
    def _message_send_mail(self, body, email_layout_xmlid, message_values, notif_values, mail_values, force_send=False, **kwargs):
        ...
        # See @tde-banana-leewise for details
