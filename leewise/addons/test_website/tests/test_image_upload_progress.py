...
from leewise.addons.web_editor.controllers.main import Web_Editor
from leewise.addons.web_unsplash.controllers.main import Web_Unsplash
...
class TestImageUploadProgress(leewise.tests.HttpCase):
