...
patch(L10nBeCodaboxSettingsButtons.prototype, {
    ...
    async l10nBeCodaboxRevoke() {
        ...
        let message = _t("This will revoke your access between CodaBox and Leewise.");
        if (nb_connections_remaining === 1) {
            message = _t(
                "This will revoke your last access between CodaBox and Leewise.\n" +
                "To be able to connect again to Leewise later on, you will have to " +
