...
from leewise.addons.payment_alipay.controllers.main import AlipayController
from leewise.addons.payment_alipay.tests.common import AlipayCommon
...
class AlipayTest(AlipayCommon, PaymentHttpCommon):
    ...
    @mute_logger('leewise.addons.payment_alipay.controllers.main')
    def test_webhook_notification_confirms_transaction(self):
        ...
        with patch(
            'leewise.addons.payment_alipay.controllers.main.AlipayController'
