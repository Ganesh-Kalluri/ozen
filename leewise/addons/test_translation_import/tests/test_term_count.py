...
from leewise.tools.misc import file_open, mute_logger, file_path
from leewise.tools.translate import TranslationModuleReader, TranslationRecordReader, code_translations, CodeTranslations, PYTHON_TRANSLATION_COMMENT, JAVASCRIPT_TRANSLATION_COMMENT, WEB_TRANSLATION_COMMENT, TranslationFileReader
from leewise import Command
from leewise.addons.base.models.ir_fields import BOOLEAN_TRANSLATIONS
...
class TestImport(common.TransactionCase):
    ...
    def test_import_from_po_file(self):
        ...
        with mute_logger('leewise.addons.base.models.res_lang'):
