...

{
    ...
    'version': '1.0',
    'description': """
Generate tasks in Project app from a form published on your website. This module requires the use of the *Form Builder* module (available in Leewise Enterprise) in order to build the form.
    """,
