# Part of Leewise. See LICENSE file for full copyright and licensing details.
{
    ...
    'website': 'https://www.leewise.in/documentation/17.0/applications/finance/fiscal_localizations/brazil.html',
...
configure Leewise in order to properly use Avatax and send the needed fiscal
...
""",
    'author': 'Akretion, Leewise Brasil',
    'depends': [
        'account',
        'base_vat',
        'l10n_latam_base',
