...
from leewise import api, http, SUPERUSER_ID, _
from leewise.exceptions import AccessDenied
from leewise.http import request, Response
from leewise import registry as registry_get
from leewise.tools.misc import clean_context

from leewise.addons.auth_signup.controllers.main import AuthSignupHome as Home
from leewise.addons.web.controllers.utils import ensure_db, _get_login_redirect_url
...
class OAuthController(http.Controller):
    ...
    def oea(self, **kw):
        """login user via Leewise Account provider"""
