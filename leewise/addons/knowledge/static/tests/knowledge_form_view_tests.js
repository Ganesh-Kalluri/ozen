...
import { onMounted, onWillStart, status } from "@leewise/owl";
...
import { parseHTML } from "@web_editor/js/editor/leewise-editor/src/utils/utils";
...
QUnit.module("Knowledge - Articles Structure Command", (hooks) => {
    ...
    QUnit.test('Check Articles Structure is correctly built', async function (assert) {
        ...
        const editable = fixture.querySelector('.leewise-editor-editable');
