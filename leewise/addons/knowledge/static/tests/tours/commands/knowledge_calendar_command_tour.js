...
registry.category("web_tour.tours").add('knowledge_calendar_command_tour', {
    ...
    trigger: '.leewise-editor-editable > p',
    run: function () {
    ...
    trigger: '.o_knowledge_editor .leewise-editor-editable h1',
    ...
    trigger: '.leewise-editor-editable',
    run: function () {
        this.$anchor.data('wysiwyg').leewiseEditor.resetContent();
    },
}, {
    // Click on the "Create Item Calednar" helper
    trigger: '.o_knowledge_helper .o_knowledge_add_item_calendar',
    extra_trigger: '.leewise-editor-editable:not(:has(.o_knowledge_behavior_type_embedded_view))',
    run: 'click',
    ...
    trigger: '.o_knowledge_editor .leewise-editor-editable',
    run: 'click',
