...
import { setSelection, boundariesIn } from "@web_editor/js/editor/leewise-editor/src/utils/utils";
...
export function appendArticleLink(htmlFieldContainerSelector, articleName, offset=0) {
    return [{ // open the command bar
        trigger: `${htmlFieldContainerSelector} .leewise-editor-editable > p:last-child`,
        run: function () {
