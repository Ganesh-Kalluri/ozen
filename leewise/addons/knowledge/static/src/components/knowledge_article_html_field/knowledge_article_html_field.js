...
export class KnowledgeArticleHtmlField extends HtmlField {
    ...
    setup() {
        ...
        onWillUnmount(() => {
            if (this.wysiwyg?.leewiseEditor) {
                this.wysiwyg.leewiseEditor.removeEventListener("historyStep", this.editorStepsCallback);
                this.wysiwyg.leewiseEditor.removeEventListener("onExternalHistorySteps", this.editorStepsCallback);
                this.wysiwyg.leewiseEditor.removeEventListener("historyResetFromSteps", this.editorStepsCallback);
            }
        });
        onWillStart(async () => {
    ...
    async startWysiwyg(wysiwyg) {
        ...
        this.wysiwyg.leewiseEditor.addEventListener("historyStep", this.editorStepsCallback);
        this.wysiwyg.leewiseEditor.addEventListener("onExternalHistorySteps", this.editorStepsCallback);
        this.wysiwyg.leewiseEditor.addEventListener("historyResetFromSteps", this.editorStepsCallback);
    }
    ...
    async _lazyloadWysiwyg() {
        ...
        this.Wysiwyg = (await leewise.loader.modules.get('@knowledge/js/knowledge_wysiwyg')).KnowledgeWysiwyg;
    }
}
