...
export class AbstractBehavior extends Component {
    static props = {
        ...
        // LeewiseEditor.editable, or the readonlyElementRef.el.
        root: { type: Element },
    ...
    setup() {
        ...
        if (!this.props.readonly) {
            onMounted(() => {
                ...
                // the rendering was done outside of the LeewiseEditor,
     ...
     * attributes from a previous Leewise version, attributes from a drop/paste
    ...
    setupAnchor() {
        ...
        if (!this.props.readonly) {
            ...
            // prevent some interactions with LeewiseEditor, @see web_editor module
    ...
    get editor () {
        return this.props.wysiwyg ? this.props.wysiwyg.leewiseEditor : undefined;
    }
}
