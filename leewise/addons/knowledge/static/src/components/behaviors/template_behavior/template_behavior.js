...
import { setCursorStart } from "@web_editor/js/editor/leewise-editor/src/utils/utils";
import {
    useRef,
    markup,
} from "@leewise/owl";
...
export class TemplateBehavior extends AbstractBehavior {
    ...
    _createHtmlDataTransfer() {
        ...
        dataTransfer.setData('text/leewise-editor', `<p></p>${content.innerHTML}<p></p>`);
        return dataTransfer;
    }
    ...
    async onClickCopyToClipboard() {
        ...
        if (document.execCommand("copy")) {
            ...
            // written in `clipboard.js` does trigger the `leewiseEditor` `copy`
