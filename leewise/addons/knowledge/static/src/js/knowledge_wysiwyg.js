...
import { isEmptyBlock } from "@web_editor/js/editor/leewise-editor/src/LeewiseEditor";
...
import { useRef } from '@leewise/owl';
 ...
 *
 * Note: The utils functions of the LeewiseEditor are included in a different bundle
...
export class KnowledgeWysiwyg extends Wysiwyg {
    ...
    setup() {
        ...
        useBus(this.env.bus, 'KNOWLEDGE_WYSIWYG:HISTORY_STEP', () => this.leewiseEditor.historyStep());
    ...
    generateArticle() {
        this.env.services.dialog.add(ChatGPTPromptDialog, {
            ...
            insert: (content) => {
                ...
                this.leewiseEditor.resetContent(divElement.innerHTML);
            }
        });
    }
    ...
    async startEdition() {
        ...
        this.leewiseEditor.options.renderingClasses = [...this.leewiseEditor.options.renderingClasses, 'focused-comment'];
    }
