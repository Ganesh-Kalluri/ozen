    ...
    macroAction() {
        ...
        action.steps.push({
            ...
            trigger: function () {
                ...
                if (dialog) {
                    return this.getFirstVisibleElement(dialog.querySelector('.o_field_html[name="body"] .leewise-editor-editable'));
                }
                return null;
            }.bind(this),
        ...
        action.steps.push({
            ...
            trigger: function () {
                ...
                const el = this.getFirstVisibleElement(
                    ...
                    (element) => element.querySelector('.leewise-editor-editable'),
                );
                if (el) {
                    return el;
                }
            ...
            trigger: function () {
                this.validatePage();
                return this.getFirstVisibleElement(`.o_field_html[name="${this.data.fieldName}"] .leewise-editor-editable`);
            }.bind(this),
            action: function (el) {
