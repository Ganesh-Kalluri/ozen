...
from leewise.tests.common import TransactionCase, can_import, RecordCapturer
from leewise.tools import mute_logger, pycompat
from leewise.tools.misc import file_open
from leewise.addons.base_import.models.base_import import ImportValidationError
from leewise.addons.test_base_import.models.test_base_import import model as base_import_model
...
class TestPreview(TransactionCase):
    ...
    @mute_logger('leewise.addons.base_import.models.base_import')
