...
from leewise import http, models, fields, _
from leewise.exceptions import AccessError
from leewise.http import request, SessionExpiredException
from leewise.osv import expression
from leewise.tools import OrderedSet, escape_psql, html_escape as escape
from leewise.addons.base.models.ir_qweb import QWebException
from leewise.addons.http_routing.models.ir_http import slug, slugify, _guess_mimetype
from leewise.addons.portal.controllers.portal import pager as portal_pager
from leewise.addons.portal.controllers.web import Home
from leewise.addons.web.controllers.binary import Binary
from leewise.addons.website.tools import get_base_domain
...
class Website(Home):
    ...
    def website_info(self, **kwargs):
        ...
        values = {
            'apps': apps,
            'l10n': l10n,
            'version': leewise.service.common.exp_version()
        }
