...
@leewise.tests.common.tagged('post_install', '-at_install', 'crawl')
class Crawler(HttpCaseWithUserDemo):
    """ Test suite crawling an Leewise CMS instance and checking that all
    ...
    def setUp(self):
        ...
        self.env.ref('website.default_website').write({
            'social_facebook': "https://www.facebook.com/Leewise",
            'social_twitter': 'https://twitter.com/Leewise',
            'social_linkedin': 'https://www.linkedin.com/company/leewise',
            'social_youtube': 'https://www.youtube.com/user/OpenERPonline',
            'social_github': 'https://github.com/leewise',
            'social_instagram': 'https://www.instagram.com/explore/tags/leewise/',
            'social_tiktok': 'https://www.tiktok.com/@leewise',
        })
