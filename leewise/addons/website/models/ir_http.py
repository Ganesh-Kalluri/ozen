...
from leewise.osv.expression import FALSE_DOMAIN
from leewise.addons.http_routing.models import ir_http
from leewise.addons.http_routing.models.ir_http import _guess_mimetype
...
def get_request_website():
    ...
    ```
    from leewise.addons.website.models import ir_http
...
class Http(models.AbstractModel):
    ...
    def _get_translation_frontend_modules_name(cls):
        ...
        installed = request.registry._init_modules.union(leewise.conf.server_wide_modules)
