...
from leewise import api, fields, models, tools, http, release, registry
from leewise.addons.http_routing.models.ir_http import RequestUID, slugify, url_for
from leewise.addons.website.models.ir_http import sitemap_qs2dom
from leewise.addons.website.tools import similarity_score, text_from_html, get_base_domain
from leewise.addons.portal.controllers.portal import pager
...
from leewise.osv.expression import AND, OR, FALSE_DOMAIN, get_unaccent_wrapper
from leewise.tools.translate import _, xml_translate
from leewise.tools import escape_psql, pycompat
...
class Website(models.Model):
    ...
    def get_website_page_ids(self):
        if not self.env.user.has_group('website.group_website_restricted_editor'):
            ...
            # (website.page) can't be access. It's how the Leewise framework works.
