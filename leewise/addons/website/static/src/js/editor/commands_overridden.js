...
import { UNMERGEABLE_SELECTORS } from "@web_editor/js/editor/leewise-editor/src/utils/sanitize";
 ...
 */
Text.prototype.oEnterLeewiseEditor = Text.prototype.oEnter;
Text.prototype.oEnter = function (offset) {
    ...
    this.oEnterLeewiseEditor(...arguments);
};
 ...
 */
HTMLElement.prototype.oDeleteBackwardLeewiseEditor = HTMLElement.prototype.oDeleteBackward;
HTMLElement.prototype.oDeleteBackward = function (offset, alreadyMoved = false, offsetLimit) {
    ...
    this.oDeleteBackwardLeewiseEditor(...arguments);
};
