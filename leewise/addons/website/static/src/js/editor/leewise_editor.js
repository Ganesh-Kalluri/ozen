...
/**
 * The goal of this patch is to correctly handle LeewiseEditor's behaviour for text
 * highlight elements.
 */
patch(LeewiseEditor.prototype, {
    /**
     * @override
     */
    _onClipboardCopy(e) {
        ...
        if (firstChild && firstChild.className && firstChild.className.includes("o_text_highlight_item")) {
            ...
            e.clipboardData.setData("text/leewise-editor", html);
        }
    },
    /**
     * @override
