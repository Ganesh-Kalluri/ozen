...
import { Component, markup, useRef, useState } from "@leewise/owl";
...
options.registry.OptionsTab = options.Class.extend({
    ...
    async updateUI() {
        ...
        // If the gray palette has been generated by Leewise standard option,
        ...
        // same hue by the Leewise editor, there might be rounding errors
                ...
                this.trigger_up('menu_dialog', {
                    ...
                    save: (name, url) => {
                        ...
                        return this.orm.call(
                            ...
                            widget.wysiwyg.leewiseEditor.observerUnactive();
                            widget.$target.attr('href', url);
                            $menu.text(name);
                            widget.wysiwyg.leewiseEditor.observerActive();
                        });
                    },
                });
                widget.popover.hide();
