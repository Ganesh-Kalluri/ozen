...
const BaseAnimatedHeader = animations.Animation.extend({
    ...
    start: function () {
        ...
        // transitionstart, so we listen to a custom leewise event.
        this._transitionCount = 0;
        this.$el.on('leewise-transitionstart.BaseAnimatedHeader', () => {
    ...
    _adaptToHeaderChange: function () {
        this.options.wysiwyg && this.options.wysiwyg.leewiseEditor.observerUnactive();
        ...
        this.options.wysiwyg && this.options.wysiwyg.leewiseEditor.observerActive();
    },
    /**
     * @private
    ...
    _updateHeaderOnScroll: function (scroll) {
        ...
        if (this.headerIsScrolled !== headerIsScrolled) {
            ...
            if (!this.scrollHeightTooShort) {
                ...
                this.$el.trigger('leewise-transitionstart');
...
publicWidget.registry.MegaMenuDropdown = publicWidget.Widget.extend({
    ...
    _moveMegaMenu(megaMenuToggleEl) {
        ...
        this.options.wysiwyg?.leewiseEditor.observerUnactive("moveMegaMenu");
        ...
        this.options.wysiwyg?.leewiseEditor.observerActive("moveMegaMenu");
    },
...
publicWidget.registry.HeaderGeneral = publicWidget.Widget.extend({
     ...
     */
    _onCollapseShow() {
        this.options.wysiwyg?.leewiseEditor.observerUnactive("addCollapseClass");
        this.el.classList.add('o_top_menu_collapse_shown');
        this.options.wysiwyg?.leewiseEditor.observerActive("addCollapseClass");
    },
    /**
     * @private
     */
    _onCollapseHidden() {
        this.options.wysiwyg?.leewiseEditor.observerUnactive("removeCollapseClass");
        this.el.classList.remove('o_top_menu_collapse_shown');
        this.options.wysiwyg?.leewiseEditor.observerActive("removeCollapseClass");
    },
    /**
     * @private
     */
