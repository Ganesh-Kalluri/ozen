...
import { useRef, useState, useSubEnv, Component, onWillStart, onMounted } from "@leewise/owl";
...
export class AddPageConfirmDialog extends Component {
    ...
    async addPage() {
        const params = {'add_menu': this.state.addMenu || '', csrf_token: leewise.csrf_token};
