...
wTourUtils.registerWebsitePreviewTour('link_tools', {
    ...
    {
        content: "Type the link URL leewise.com",
        trigger: '#toolbar:not(.oe-floating) #o_link_dialog_url_input',
        run: 'text leewise.com'
    },
    clickOnImgStep,
    // 2. Edit the link with the link tools.
    {
        content: "Click on the newly created link",
        trigger: 'iframe .s_text_image a[href="http://leewise.com"]:contains("leewise.com")',
    },
    {
        content: "Change content (editing the label input) to leewise website_2",
        trigger: '#o_link_dialog_label_input:propValue(leewise.com)',
        run: 'text leewise website_2',
    },
    {
        content: "Click again on the link",
        trigger: 'iframe .s_text_image a[href="http://leewise.com"]:contains("leewise website_2")',
    },
    {
    ...
    {
        content: "Click again on the link",
        trigger: 'iframe .s_text_image a[href="http://leewise.com"]:contains("leewise website")',
    },
    {
    ...
    },
    {
        ...
        trigger: 'iframe .popover div a:contains("http://leewise.com")',
        isCheck: true,
    },
    // 5. Remove link from image.
    {
        content: "Remove link.",
        trigger: 'iframe .popover:contains("http://leewise.com") a .fa-chain-broken',
    },
    {
    ...
    {
        content: "Select text",
        trigger: 'iframe #wrap .s_text_image p:contains(leewise.com)',
        run() {
    ...
    clickOnImgStep,
    {
        ...
        trigger: "iframe .s_text_image p a[href='http://leewise.com']:contains('leewise.com')",
        isCheck: true,
    },
    {
    ...
    // 8. Check that http links are not coerced to https and vice-versa.
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run: 'text https://leewise.com',
    },
    {
        content: "Check that link was updated",
        trigger: "iframe .s_text_image p a[href='https://leewise.com']:contains('leewise.com')",
        isCheck: true,
    },
    {
        content: "Change it back http",
        trigger: "#o_link_dialog_url_input",
        run: 'text http://leewise.com',
    },
    {
        content: "Check that link was updated",
        trigger: "iframe .s_text_image p a[href='http://leewise.com']:contains('leewise.com')",
