...
from leewise.addons.whatsapp.tests.common import WhatsAppCommon
...
Welcome to {{4}} office''',
                ...
                'variable_ids': [
                    ...
                    (0, 0, {'name': "{{4}}", 'line_type': "body", 'field_type': "free_text", 'demo_value': "Leewise In"}),
                ],
                'wa_account_id': cls.whatsapp_account.id,
            }
        ])
...
class WhatsAppComposerInternals(WhatsAppComposerCase, CronMixinCase):
    ...
    def test_composer_tpl_button(self):
        ...
        for button_values in [
            ...
            {'button_type': 'url', 'website_url': 'https://www.leewise.in'},
        ]:
