...
from leewise import api, models, fields, _, Command
from leewise.addons.http_routing.models.ir_http import slugify
from leewise.addons.whatsapp.tools.lang_list import Languages
from leewise.addons.whatsapp.tools.whatsapp_api import WhatsAppApi
from leewise.addons.whatsapp.tools.whatsapp_exception import WhatsAppError
from leewise.exceptions import UserError, ValidationError, AccessError
from leewise.tools import plaintext2html
...
class WhatsAppTemplate(models.Model):
    ...
    def _update_template_from_response(self, remote_template_vals):
        ...
        # variables should be preserved instead of overwritten to keep leewise-specific data like fields
        variable_ids = []
