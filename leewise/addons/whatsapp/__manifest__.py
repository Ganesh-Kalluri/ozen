...
{
    'name': 'Leewise WhatsApp Integration',
    'category': 'WhatsApp',
    'summary': 'Integrates Leewise with WhatsApp to use WhatsApp messaging service',
    'version': '1.0',
    'description': """This module integrates Leewise with WhatsApp to use WhatsApp messaging service""",
