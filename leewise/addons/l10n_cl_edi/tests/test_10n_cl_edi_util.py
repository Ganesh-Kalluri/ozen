...
class TestL10nClDte(TestL10nClEdiCommon):
    @patch('leewise.addons.l10n_cl_edi.models.l10n_cl_edi_util.L10nClEdiUtilMixin._get_seed_ws')
    ...
    @patch('leewise.addons.l10n_cl_edi.models.l10n_cl_edi_util.Client')
    @patch('leewise.addons.l10n_cl_edi.models.l10n_cl_edi_util.L10nClEdiUtilMixin._get_signed_token')
    @patch('leewise.addons.l10n_cl_edi.models.l10n_cl_edi_util.L10nClEdiUtilMixin._get_seed_ws')
    ...
    @patch('leewise.addons.l10n_cl_edi.models.l10n_cl_edi_util.Client')
    @patch('leewise.addons.l10n_cl_edi.models.l10n_cl_edi_util.L10nClEdiUtilMixin._get_signed_token')
    @patch('leewise.addons.l10n_cl_edi.models.l10n_cl_edi_util.L10nClEdiUtilMixin._get_seed')
