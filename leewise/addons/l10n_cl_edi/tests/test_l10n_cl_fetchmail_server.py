...
@patch('leewise.tools.xml_utils._check_with_xsd', _check_with_xsd_patch)
class TestFetchmailServer(TestL10nClEdiCommon):
    ...
    @patch('leewise.fields.Date.context_today', return_value=fields.Date.from_string('2019-11-23'))
    ...
    @patch('leewise.addons.base_vat.models.res_partner.ResPartner.check_vat', MagicMock())
    def test_create_invoice_33_from_attachment_with_sending_partner_defined_on_other_company(self):
        ...
        # Sudo to run like when LeewiseBot does the fetching. If we use a normal user,
    ...
    @patch('leewise.addons.l10n_cl_edi.models.fetchmail_server.FetchmailServer._get_dte_lines')
    ...
    @patch('leewise.addons.l10n_cl_edi.models.l10n_cl_edi_util.L10nClEdiUtilMixin._get_cl_current_strftime')
