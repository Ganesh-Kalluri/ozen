...
from leewise import models, api, service
from leewise.tools.translate import _
from leewise.exceptions import UserError
from leewise.tools import DEFAULT_SERVER_DATETIME_FORMAT, misc
...
class MercuryTransaction(models.Model):
    ...
    def _setup_request(self, data):
        ...
        data['memo'] = "Leewise " + service.common.exp_version()['server_version']
