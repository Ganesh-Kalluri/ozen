...
from leewise.tools import float_repr, mute_logger

from leewise.addons.payment.tests.http_common import PaymentHttpCommon
from leewise.addons.payment_paypal.controllers.main import PaypalController
from leewise.addons.payment_paypal.tests.common import PaypalCommon
...
class PaypalTest(PaypalCommon, PaymentHttpCommon):
    ...
    @mute_logger('leewise.addons.payment_paypal.controllers.main')
    def test_webhook_notification_confirms_transaction(self):
        """ Test the processing of a webhook notification. """
        tx = self._create_transaction('redirect')
        url = self._build_url(PaypalController._webhook_url)
        with patch(
            'leewise.addons.payment_paypal.controllers.main.PaypalController'
