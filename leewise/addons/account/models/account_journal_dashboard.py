...
from leewise import models, api, _, fields
from leewise.exceptions import UserError
from leewise.osv import expression
from leewise.release import version
from leewise.tools import DEFAULT_SERVER_DATE_FORMAT as DF
from leewise.tools.misc import formatLang, format_date as leewise_format_date, get_lang
    ...
    def _get_json_activity_data(self):
        ...
        for activity in self.env.cr.dictfetchall():
            act = {
                ...
                'date': leewise_format_date(self.env, activity['date_deadline'])
            }
