...
The Leewise <a href="https://www.leewise.in/app/accounting">Open Source Accounting</a> app allows a better way to
...
in one place. Leewise's user interface is designed with productivity in mind.
...
accounting; Leewise has all the features you need to sustain all your business
activities.

Scale With Your Organization
----------------------------

Leewise supports multiple currencies, multiple users with different access rights,
