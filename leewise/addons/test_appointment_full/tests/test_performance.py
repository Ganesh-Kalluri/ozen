...
from leewise.addons.appointment.tests.test_performance import AppointmentUIPerformanceCase
from leewise.addons.appointment_hr.tests.test_performance import AppointmenHrPerformanceCase
