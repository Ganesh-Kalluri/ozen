...
from leewise.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE_PLAINTEXT
...
from leewise.api import call_kw
from leewise.exceptions import AccessError
from leewise.tests import tagged
from leewise.tools import mute_logger, formataddr
...
class TestMessageNotify(TestMessagePostCommon):
    ...
    @users('employee')
    @mute_logger('leewise.addons.mail.models.mail_mail', 'leewise.models.unlink', 'leewise.tests')
...
class TestMessagePost(TestMessagePostCommon, CronMixinCase):
    ...
    def test_message_post_inactive_follower(self):
        """ Test posting with inactive followers does not notify them (e.g. leewisebot) """
        test_record = self.env['mail.test.simple'].browse(self.test_record.ids)
                ...
                with self.assertSinglePostNotifications(
                        ...
                        message_info={
                            ...
                            'mail_mail_values': {
                                'headers': {
                                    'Return-Path': f'{expected_alias_domain.bounce_alias}@{expected_alias_domain.name}',
                                    'X-Leewise-Objects': f'{record._name}-{record.id}',
                                },
                            },
                            'message_values': {
    ...
    @mute_logger('leewise.addons.mail.models.mail_mail', 'leewise.tests')
    ...
    @users('employee')
    @mute_logger('leewise.addons.mail.models.mail_mail', 'leewise.addons.mail.models.mail_message_schedule', 'leewise.models.unlink')
    ...
    @mute_logger('leewise.addons.mail.models.mail_mail', 'leewise.addons.mail.models.mail_message_schedule')
    ...
    @mute_logger('leewise.addons.base.models.ir_model', 'leewise.addons.mail.models.mail_mail')
    ...
    @mute_logger('leewise.addons.mail.models.mail_mail', 'leewise.addons.mail.models.mail_thread')
    @users('employee')
