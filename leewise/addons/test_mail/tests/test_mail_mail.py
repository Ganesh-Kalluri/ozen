...
from leewise import api, Command
from leewise.addons.base.models.ir_mail_server import MailDeliveryException
from leewise.addons.mail.tests.common import MailCommon
from leewise.exceptions import AccessError
from leewise.tests import common, tagged, users
from leewise.tools import formataddr, mute_logger, DEFAULT_SERVER_DATETIME_FORMAT
...
class TestMailMail(MailCommon):
    ...
    def test_mail_mail_send_exceptions_origin(self):
        ...
        for default_from in [False, '']:
            ...
            self._reset_data()
            with self.mock_mail_gateway(), mute_logger('leewise.addons.mail.models.mail_mail'):
...
class TestMailMailRace(common.TransactionCase):
    ...
    def test_mail_bounce_during_send(self):
        ...
        def send_email(self, message, *args, **kwargs):
            with this.registry.cursor() as cr, mute_logger('leewise.sql_db'):
                try:
