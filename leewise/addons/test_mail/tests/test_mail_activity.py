...
from leewise import fields, exceptions, tests
from leewise.addons.mail.tests.common import mail_new_test_user, MailCommon
from leewise.addons.test_mail.models.test_mail_models import MailTestActivity
from leewise.tools import mute_logger
from leewise.tests.common import Form, users
...
class TestActivityMixin(TestActivityCommon):
    ...
    def test_mail_activity_state(self):
        ...
        with patch('leewise.addons.mail.models.mail_activity.datetime', MockedDatetime):
    ...
    def test_mail_activity_mixin_search_state_basic(self):
        ...
        with patch('leewise.addons.mail.models.mail_activity.datetime', MockedDatetime), \
            patch('leewise.addons.mail.models.mail_activity_mixin.datetime', MockedDatetime):
