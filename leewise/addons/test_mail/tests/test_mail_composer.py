...
from leewise.addons.mail.wizard.mail_compose_message import MailComposer
from leewise.addons.test_mail.models.test_mail_models import MailTestTicket
from leewise.addons.test_mail.tests.common import TestRecipients
from leewise.fields import Datetime as FieldDatetime
from leewise.exceptions import AccessError
from leewise.tests import tagged
from leewise.tests.common import users, Form
from leewise.tools import email_normalize, mute_logger, formataddr
...
class TestComposerInternals(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('leewise.tests', 'leewise.addons.mail.models.mail_mail', 'leewise.models.unlink')
    ...
    @mute_logger('leewise.tests', 'leewise.addons.base.models.ir_rule', 'leewise.addons.mail.models.mail_mail', 'leewise.models.unlink')
...
class TestComposerResultsComment(TestMailComposer, CronMixinCase):
    ...
    @users('employee')
    @mute_logger('leewise.models.unlink', 'leewise.addons.mail.models.mail_mail', 'leewise.addons.mail.models.mail_message_schedule')
...
class TestComposerResultsMass(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('leewise.models.unlink', 'leewise.addons.mail.models.mail_mail')
