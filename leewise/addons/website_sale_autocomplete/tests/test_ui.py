...
from leewise.addons.website_sale_autocomplete.controllers.main import AutoCompleteController
from leewise.tests import patch, HttpCase, tagged

CONTROLLER_PATH = 'leewise.addons.website_sale_autocomplete.controllers.main.AutoCompleteController'
