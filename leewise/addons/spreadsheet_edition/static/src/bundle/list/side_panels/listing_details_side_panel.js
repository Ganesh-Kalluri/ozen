...
export class ListingDetailsSidePanel extends Component {
    ...
    onNameChanged(name) {
        this.env.model.dispatch("RENAME_LEEWISE_LIST", {
    ...
    async refresh() {
        this.env.model.dispatch("REFRESH_LEEWISE_LIST", { listId: this.props.listId });
    ...
    openDomainEdition() {
        this.dialog.add(DomainSelectorDialog, {
            ...
            onConfirm: (domain) =>
                this.env.model.dispatch("UPDATE_LEEWISE_LIST_DOMAIN", {
                    listId: this.props.listId,
