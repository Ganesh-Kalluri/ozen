...
import { Component, useState, useExternalListener, useRef, onMounted } from "@leewise/owl";
...
export class IrMenuSelectorDialog extends Component {
    setup() {
        ...
        useExternalListener(document.body, "click", (ev) => {
            ev.stopPropagation();
            ev.preventDefault(); // stop jumping to leewise home page
        });
    }
    _onConfirm() {
...
IrMenuSelectorDialog.title = _t("Select an Leewise menu to link in your spreadsheet");
