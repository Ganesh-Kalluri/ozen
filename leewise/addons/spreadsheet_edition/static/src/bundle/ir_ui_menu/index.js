...
import {
    ...
    buildViewLink,
    buildIrMenuXmlLink,
} from "@spreadsheet/ir_ui_menu/leewise_menu_link_cell";
 ...
 * @param {import("@spreadsheet/ir_ui_menu/leewise_menu_link_cell").ViewLinkDescription} actionToLink
...
linkMenuRegistry.add("leewiseMenu", {
    name: _t("Link an Leewise menu"),
    sequence: 20,
    execute: async (env) => {
