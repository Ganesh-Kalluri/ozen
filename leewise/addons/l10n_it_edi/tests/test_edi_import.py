...
from leewise import fields, sql_db, tools
from leewise.tests import tagged
from leewise.addons.l10n_it_edi.tests.common import TestItEdi
...
class TestItEdiImport(TestItEdi):
    ...
    def test_receive_same_vendor_bill_twice(self):
        ...
        with (patch.object(proxy_user.__class__, '_decrypt_data', return_value=self.fake_test_content),
              ...
              tools.mute_logger("leewise.addons.l10n_it_edi.models.account_move")):
