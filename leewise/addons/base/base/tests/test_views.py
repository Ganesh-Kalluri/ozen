...
from leewise.tools import get_cache_key_counter, mute_logger, view_validation, safe_eval
from leewise.addons.base.models import ir_ui_view
...
class ViewCase(TransactionCaseWithUserDemo):
    ...
    def assertWarning(self, arch, expected_message=None, name='invalid view'):
        with self.assertLogs('leewise.addons.base.models.ir_ui_view', level="WARNING") as log_catcher:
            self.View.create({
                'name': name,
                'model': 'ir.ui.view',
                'arch': arch,
