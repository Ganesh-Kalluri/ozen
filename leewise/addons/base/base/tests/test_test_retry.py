...
from leewise.tests import BaseCase, tagged
...
class TestRetryCommon(BaseCase):
    def get_tests_run_count(self):
        return int(os.environ.get('LEEWISE_TEST_FAILURE_RETRIES', 0)) + 1
...
class TestRetry(TestRetryCommon):
    """ Check some tests behaviour when LEEWISE_TEST_FAILURE_RETRIES is set"""
