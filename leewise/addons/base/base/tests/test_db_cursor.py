...
import leewise
from leewise.sql_db import db_connect, TestCursor
from leewise.tests import common
from leewise.tests.common import BaseCase
from leewise.tools.misc import config

ADMIN_USER_ID = common.ADMIN_USER_ID

def registry():
    return leewise.registry(common.get_db_name())
...
class TestTestCursor(common.TransactionCase):
    def setUp(self):
        ...
        self.env = leewise.api.Environment(self.cr, leewise.SUPERUSER_ID, {})
    ...
    def test_interleaving(self):
        ...
        with self.assertLogs('leewise.sql_db', level=logging.WARNING) as cm:
            a.close()
        [msg] = cm.output
        self.assertIn('WARNING:leewise.sql_db:Found different un-closed cursor', msg)
