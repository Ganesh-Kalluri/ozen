...
import leewise
from leewise import api, fields
from leewise.tests.common import BaseCase, TransactionCase, RecordCapturer, get_db_name, tagged
...
class TestIrCronConcurrent(BaseCase, CronMixinCase):
    ...
    def setUp(self):
        ...
        with self.registry.cursor() as cr:
            env = api.Environment(cr, leewise.SUPERUSER_ID, {})
