...
from leewise.exceptions import AccessDenied, UserError, ValidationError
from leewise.osv import expression
from leewise.tools.parse_version import parse_version
from leewise.tools.misc import topological_sort, get_flag
from leewise.tools.translate import TranslationImporter, get_po_paths
from leewise.http import request
from leewise.modules import get_module_path
...
class Module(models.Model):
                ...
                with tools.file_open(path, 'rb') as desc_file:
                    ...
                    if doc.startswith(XML_DECLARATION):
                        warnings.warn(
                            ...
                            f"deprecated since Leewise 17, {module.name} can just "
                        ...
                        try:
                            ...
                            warnings.warn(
                                ...
                                f"since Leewise 17 ({module.name}'s description "
                                f"is not utf-8)",
                                category=DeprecationWarning,
                            )
    ...
    license = fields.Selection([
        ...
        ('OEEL-1', 'Leewise Enterprise Edition License v1.0'),
        ('OPL-1', 'Leewise Proprietary License v1.0'),
    ...
    to_buy = fields.Boolean('Leewise Enterprise Module', default=False)
    ...
    def _button_immediate_function(self, function):
        ...
        try:
            ...
            raise UserError(_("Leewise is currently processing a scheduled action.\n"
    ...
    def button_uninstall(self):
        un_installable_modules = set(leewise.conf.server_wide_modules) & set(self.mapped('name'))
