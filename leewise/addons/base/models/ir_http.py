...
import leewise
from leewise import api, http, models, tools, SUPERUSER_ID
from leewise.exceptions import AccessDenied, AccessError, MissingError
from leewise.http import request, Response, ROUTING_KEYS, Stream
from leewise.modules.registry import Registry
from leewise.service import security
from leewise.tools import get_lang, submap
...
class IrHttp(models.AbstractModel):
    ...
    def _pre_dispatch(cls, rule, args):
        ...
        for key, val in list(args.items()):
            ...
            try:
            ...
            except (leewise.exceptions.AccessError, leewise.exceptions.MissingError) as e:
                ...
                if isinstance(e, leewise.exceptions.MissingError):
    ...
    def routing_map(self, key=None):
        ...
        installed = registry._init_modules.union(leewise.conf.server_wide_modules)
        if tools.config['test_enable'] and leewise.modules.module.current_test:
            installed.add(leewise.modules.module.current_test)
