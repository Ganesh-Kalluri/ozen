...
from leewise.exceptions import MissingError, UserError
from leewise.http import Stream, request
from leewise.tools import file_open, replace_exceptions
from leewise.tools.image import image_process, image_guess_size_from_field_name
from leewise.tools.mimetypes import guess_mimetype, get_extension
...
class IrBinary(models.AbstractModel):
    ...
    def _get_stream_from(
        ...
        """
        Create a :class:leewise.http.Stream: from a record's binary field.
    ...
    def _get_image_stream_from(
        ...
        :meth:`~leewise.models.BaseModel._get_placeholder_filename` which
        ...
        accordingly. See also :func:`leewise.tools.image.image_process`.
