...
import leewise
from leewise import api, fields, models, tools, _, Command
from leewise.exceptions import MissingError, ValidationError, AccessError, UserError
from leewise.tools import frozendict
from leewise.tools.safe_eval import safe_eval, test_python_expr
from leewise.tools.float_utils import float_compare
...
class IrActionsServer(models.Model):
    ...
    Since Leewise 8.0 a button 'Create Menu Action' button is available on the
...
# To return an action, assign: action = {...}\n\n\n\n"""
    ...
    def _get_eval_context(self, action=None):
        ...
        eval_context.update({
            ...
            'model': model,
            # Exceptions
            'UserError': leewise.exceptions.UserError,
            # record
            'record': record,
            'records': records,
            # helpers
