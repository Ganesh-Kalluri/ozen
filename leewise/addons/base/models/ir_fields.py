...
from leewise.tools import ustr, OrderedSet
from leewise.tools.translate import code_translations, _lt
...
class IrFieldsConverter(models.AbstractModel):
    ...
    def for_model(self, model, fromtype=str):
        ...
        callable taking a record-ish (a dictionary representing an leewise
        record with values of typetag ``fromtype``) and returning a converted
        records matching what :meth:`leewise.osv.orm.Model.write` expects.

        :param model: :class:`leewise.osv.orm.Model` for the conversion base
        :param fromtype:
    ...
    def to_field(self, model, field, fromtype=str):
        ...
        :type field: :class:`leewise.fields.Field`
