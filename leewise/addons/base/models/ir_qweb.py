...
QWeb is the primary templating engine used by Leewise. It is an XML templating
...
<https://www.leewise.in/documentation/17.0/developer/reference/frontend/qweb.html>`
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
**Values**: name of the allowed leewise user group, or preceded by ``!`` for
prohibited groups

The generated code uses ``user_has_groups`` Leewise method.
...
from leewise import api, models, tools
from leewise.modules import registry
from leewise.tools import config, safe_eval, pycompat
from leewise.tools.constants import SUPPORTED_DEBUGGER, EXTERNAL_ASSET
from leewise.tools.safe_eval import assert_valid_codeobj, _BUILTINS, to_opcodes, _EXPR_OPCODES, _BLACKLIST
from leewise.tools.json import scriptsafe
from leewise.tools.lru import LRU
from leewise.tools.misc import str2bool
from leewise.tools.image import image_data_uri, FILETYPE_BASE64_MAGICWORD
from leewise.http import request
from leewise.tools.profiler import QwebTracker
from leewise.exceptions import UserError, AccessDenied, AccessError, MissingError, ValidationError

from leewise.addons.base.models.assetsbundle import AssetsBundle
from leewise.tools.constants import SCRIPT_EXTENSIONS, STYLE_EXTENSIONS, TEMPLATE_EXTENSIONS
    ...
    * to customize ``t-field`` rendering, subclass ``ir.qweb.field`` and
    ...
    def _debug_trace(self, debugger, values):
        ...
        if not debugger:
            ...
            warnings.warn(
                ...
                "since Leewise 17.0, keep the value empty and configure the "
    ...
    def _link_to_node(self, path, defer_load=False, lazy_load=False, media=None):
        ...
        if is_js:
            ...
            if is_asset_bundle:
                attributes['onerror'] = "__leewiseAssetError=1"
