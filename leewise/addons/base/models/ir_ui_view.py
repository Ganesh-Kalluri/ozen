...
from leewise.exceptions import ValidationError, AccessError, UserError
from leewise.http import request
from leewise.modules.module import get_resource_from_path
from leewise.tools import config, ConstantMapping, get_diff, pycompat, apply_inheritance_specs, locate_node, str2bool
from leewise.tools import safe_eval, lazy, lazy_property, frozendict
from leewise.tools.convert import _fix_multiple_roots
from leewise.tools.misc import file_path
from leewise.tools.translate import xml_translate, TRANSLATED_ATTRS
from leewise.tools.view_validation import valid_view, get_domain_value_names, get_expression_field_names, get_dict_asts
from leewise.models import check_method_name
from leewise.osv.expression import expression
...
@lazy
def keep_query():
    mod = leewise.addons.base.models.ir_qweb
