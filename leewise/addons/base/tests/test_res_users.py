...
from leewise.addons.base.models.res_users import is_selection_groups, get_selection_groups, name_selection_groups
from leewise.exceptions import UserError
from leewise.tests.common import Form, TransactionCase, new_test_user, tagged
...
class TestUsers(TransactionCase):
    ...
    @mute_logger('leewise.sql_db', 'leewise.addons.base.models.res_users_deletion')
    ...
    def test_context_get_lang(self):
        ...
        request_patch = patch('leewise.addons.base.models.res_users.request', request)
