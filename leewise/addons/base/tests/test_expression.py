...
from leewise.addons.base.tests.common import SavepointCaseWithUserDemo
from leewise.fields import Date
from leewise.models import BaseModel
from leewise.tests.common import BaseCase, TransactionCase
...
class TestExpression(SavepointCaseWithUserDemo):
    ...
    def test_10_hierarchy_in_m2m(self):
        ...
        with self.assertLogs('leewise.osv.expression'):
    ...
    def test_accent(self):
        ...
        with patch('leewise.osv.expression.get_unaccent_wrapper') as w:
    ...
    def test_like_cast(self):
        ...
        with mute_logger('leewise.sql_db'), self.assertRaises(psycopg2.Error):
