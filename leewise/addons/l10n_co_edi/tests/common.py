# coding: utf-8
from leewise.addons.account_edi.tests.common import AccountEdiTestCommon
    ...
    def mock_carvajal(self):
        ...
        try:
            with freeze_time(self.frozen_today), \
                 patch('leewise.addons.l10n_co_edi.models.carvajal_request.CarvajalRequest.upload',
                       new=Mock(return_value=return_value_upload)), \
                 patch('leewise.addons.l10n_co_edi.models.carvajal_request.CarvajalRequest.check_status',
                       new=Mock(return_value=return_value_check)), \
                 patch('leewise.addons.l10n_co_edi.models.carvajal_request.CarvajalRequest.client',
