...
from leewise.addons.payment_sips.controllers.main import SipsController
from leewise.addons.payment_sips.tests.common import SipsCommon
...
class SipsTest(SipsCommon, PaymentHttpCommon):
    ...
    @mute_logger('leewise.addons.payment_sips.controllers.main')
    def test_webhook_notification_confirms_transaction(self):
        """ Test the processing of a webhook notification. """
        tx = self._create_transaction('redirect')
        url = self._build_url(SipsController._return_url)
        with patch(
            'leewise.addons.payment_sips.controllers.main.SipsController'
