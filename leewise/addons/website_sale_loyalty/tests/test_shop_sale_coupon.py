...
from leewise.tests import HttpCase, tagged, TransactionCase
from leewise.addons.sale.tests.test_sale_product_attribute_value_config import TestSaleProductAttributeValueCommon
