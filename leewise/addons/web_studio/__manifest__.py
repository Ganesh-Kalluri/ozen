...
{
    'name': "Studio",
    'summary': "Create and customize your Leewise apps",
    'website': 'https://www.leewise.in/app/studio',
    'description': """
Studio - Customize Leewise
=======================
...
""",
    ...
    'assets': {
        ...
        'web_studio.report_assets': [
            ...
            "web_editor/static/src/js/editor/leewise-editor/src/**/*",
            ("remove", "web_editor/static/src/js/editor/leewise-editor/src/qweb_sample.js")
        ],
