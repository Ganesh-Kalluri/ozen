...
from leewise.addons.web_studio.controllers import export
from leewise.osv import expression
from leewise.tools import ustr, sql, clean_context
...
class WebStudioController(http.Controller):
    ...
    def _generate_studio_view_name(self, view):
        return "Leewise Studio: %s customization" % (view.name)
