...
from leewise.addons.web_studio.controllers.export import MODELS_TO_EXPORT, FIELDS_TO_EXPORT, \
     FIELDS_NOT_TO_EXPORT, CDATA_FIELDS, XML_FIELDS
from leewise.addons.web_studio.models.ir_model import OPTIONS_WL
...
class TestStudioIrModel(TransactionCase):
    ...
    def test_performance_01_fields_batch(self):
        ...
        orig_setup_models = leewise.modules.registry.Registry.setup_models
        def setup_models(registry, cr):
            nonlocal count_setup_models
            count_setup_models += 1
            orig_setup_models(registry, cr)
        with patch('leewise.modules.registry.Registry.setup_models', new=setup_models):
