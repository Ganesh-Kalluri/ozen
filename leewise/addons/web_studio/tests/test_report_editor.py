...
from leewise.addons.base.models.ir_actions_report import IrActionsReport
from leewise.addons.web_studio.controllers.main import WebStudioController
from leewise.addons.web_studio.controllers.report import WebStudioReportController, get_report_view_copy, _get_and_write_studio_view
from leewise.addons.web.controllers.report import ReportController
from leewise.http import _request_stack, route
from leewise.tests.common import HttpCase, TransactionCase
from leewise.tests import tagged
from leewise.tools import DotDict, mute_logger
...
class TestReportEditorUIUnit(HttpCase):
    ...
    def test_basic_report_edition(self):
        ...
        self.assertXMLEqual(main_arch, """
            <t t-name="web_studio.test_report">
               <t t-call="web.html_container">
                 <div>
                   <p>edited with leewise editor</p>
                 </div>
                 <t t-foreach="docs" t-as="doc">
                   <t t-call="web_studio.test_report_document"/>
                 </t>
        ...
        self.assertXMLEqual(doc_arch, """
            <t t-name="web_studio.test_report_document">
               ...
               <p>edited with leewise editor 2</p>
             </t>
        """)
        self.assertXMLEqual(studio_arch, """
        <data>
    ...
    def test_table_rendering(self):
        ...
        self.assertXMLEqual(arch, """
            <t t-name="web_studio.test_report_document">
               <p>p edited with leewiseEditor</p>
               <table class="valid_table">
                 <tbody>
                   <tr>
                     <td>I am valid</td>
               ...
               <table class="invalid_table">
                 <t t-foreach="doc.child_ids" t-as="child">
                   <tr>
                     <td>edited with leewiseEditor</td>
                   </tr>
                 </t>
               </table>
             </t>
    ...
    def test_field_placeholder(self):
        ...
        self.assertXMLEqual(arch, """
            <t t-name="web_studio.test_report">
               <t t-call="web.html_container">
                 <div>
                   <p><br/>edited with leewiseEditor</p>
                 </div>
                 <t t-foreach="docs" t-as="doc">
                   <t t-call="web_studio.test_report_document"/>
                 </t>
