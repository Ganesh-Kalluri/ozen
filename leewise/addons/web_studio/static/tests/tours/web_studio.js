    ...
    steps: () => [
        {
            ...
            content: markup(
                _t("Want to customize the background? Let’s activate <b>Leewise Studio</b>.")
            ),
            position: "bottom",
...
registry.category("web_tour.tours").add("web_studio_new_app_tour", {
    ...
    steps: () => [
        ...
        },
        {
            ...
            content: markup(
                _t(
                    "Let’s check the result. Close Leewise Studio to get an <b>overview of your app</b>."
                )
            ),
            position: "left",
        },
        ...
        },
        {
            ...
            content: markup(
                _t(
                    "Wow, nice! And I’m sure you can make it even better! Use this icon to open <b>Leewise Studio</b> and customize any screen."
                )
            ),
            position: "bottom",
        },
