...
The eBay integrator gives you the opportunity to manage your Leewise's products on eBay.
...
* Automatic creation of sales order and invoices
  ...
  # Check https://github.com/leewise/leewise/blob/master/leewise/addons/base/data/ir_module_category_data.xml
  # for the full list
