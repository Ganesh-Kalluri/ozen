...
class SocialLivePostPushNotifications(models.Model):
    ...
    def _post_push_notifications(self):
        for live_post in self:
            ...
            icon_url = '/social_push_notifications/social_post/%s/push_notification_image' % post.id if post.push_notification_image else '/mail/static/src/img/leewisebot_transparent.png'
