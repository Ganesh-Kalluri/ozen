...
class PatchedHTTPAdapter(requests.adapters.HTTPAdapter):
    ...
    def cert_verify(self, conn, url, verify, cert):
        ...
        # In our case, cert is an leewise record 'l10n_es_edi.certificate' so not a path to a file.
    ...
    def get_connection(self, url, proxies=None):
        ...
        def patched_load_cert_chain(l10n_es_leewise_certificate, keyfile=None, password=None):
            cert_file, key_file, _certificate = l10n_es_leewise_certificate.sudo()._decode_certificate()
