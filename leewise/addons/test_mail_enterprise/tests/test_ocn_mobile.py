...
class TestMailMobile(SMSCommon):
    ...
    def setUpClass(cls):
        ...
        cls.env['ir.config_parameter'].sudo().set_param('web.base.url', 'http://yourcompany.leewise.com')
    ...
    def test_override_url_in_mail(self):
        ...
        original_expected_link = 'http://yourcompany.leewise.com/mail/view?model=mail.activity&res_id=1'
