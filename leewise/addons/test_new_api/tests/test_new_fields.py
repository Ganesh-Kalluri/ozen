...
from leewise import models, fields, Command
from leewise.addons.base.tests.common import TransactionCaseWithUserDemo
from leewise.exceptions import AccessError, MissingError, UserError, ValidationError
from leewise.tests import common
from leewise.tools import mute_logger, float_repr
from leewise.tools.date_utils import add, subtract, start_of, end_of
from leewise.tools.image import image_data_uri
...
%endif"""
    ...
    @mute_logger('leewise.addons.base.models.ir_model')
    ...
    def test_85_binary_guess_zip(self):
        from leewise.addons.base.tests.test_mimetypes import ZIP
    ...
    def test_86_text_base64_guess_svg(self):
        from leewise.addons.base.tests.test_mimetypes import SVG
...
class TestX2many(common.TransactionCase):
    ...
    def test_10_ondelete_many2many(self):
        ...
        with self.assertRaises(psycopg2.IntegrityError):
            with mute_logger('leewise.sql_db'), self.cr.savepoint():
                record_a.unlink()
...
%endif"""
    ...
    @patch('leewise.fields.html_sanitize', return_value='<p>comment</p>')
...
class TestFieldParametersValidation(common.TransactionCase):
    def test_invalid_parameter(self):
        ...
        with self.assertLogs('leewise.fields', level='WARNING') as cm:
            self.registry.setup_models(self.env.cr)

        self.assertTrue(cm.output[0].startswith(
            "WARNING:leewise.fields:Field test_new_api.field_parameter_validation.name: "
