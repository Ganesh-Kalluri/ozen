...
from leewise import _, models, release
from leewise.addons.l10n_es_edi_sii.models.account_edi_format import PatchedHTTPAdapter
from leewise.addons.l10n_es_edi_tbai.models.l10n_es_edi_tbai_agencies import get_key
from leewise.addons.l10n_es_edi_tbai.models.xml_utils import (
...
from leewise.tools import get_lang
from leewise.tools.float_utils import float_repr, float_round
from leewise.tools.xml_utils import cleanup_xml_node, validate_xml_from_attachment
...
class AccountEdiFormat(models.Model):
    ...
    def _l10n_es_tbai_get_header_values(self, invoice):
        return {
            ...
            'leewise_version': release.version,
        }
