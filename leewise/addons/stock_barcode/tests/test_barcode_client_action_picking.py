...
from leewise.addons.stock_barcode.tests.test_barcode_client_action import TestBarcodeClientAction
...
class TestPickingBarcodeClientAction(TestBarcodeClientAction):
    def test_internal_picking_from_scratch(self):
        ...
        picking_write_orig = leewise.addons.stock.models.stock_picking.Picking.write
        picking_button_validate_orig = leewise.addons.stock.models.stock_picking.Picking.button_validate
        ...
        with patch('leewise.addons.stock.models.stock_picking.Picking.write', new=picking_write_mock),\
             patch('leewise.addons.stock.models.stock_picking.Picking.button_validate', new=picking_button_validate_mock):
    ...
    def test_internal_picking_reserved_1(self):
        ...
        leewise.addons.stock.models.stock_picking.Picking.write
        url = self._get_client_action_url(internal_picking.id)
