...
from leewise import _, fields, models, service
from leewise.exceptions import ValidationError

from leewise.addons.payment_mollie import const
...
class PaymentProvider(models.Model):
    ...
    def _mollie_make_request(self, endpoint, data=None, method='POST'):
        ...
        leewise_version = service.common.exp_version()['server_version']
        ...
        headers = {
            ...
            "User-Agent": f'Leewise/{leewise_version} MollieNativeLeewise/{module_version}',
        }
