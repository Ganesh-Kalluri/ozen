...
from leewise import Command, exceptions, http, fields, _
from leewise.http import request, route
from leewise.osv import expression
from leewise.tools import plaintext2html, DEFAULT_SERVER_DATETIME_FORMAT as dtf
from leewise.tools.mail import is_html_empty
from leewise.tools.misc import babel_locale_parse, get_lang
from leewise.addons.base.models.ir_qweb import keep_query
from leewise.addons.base.models.res_partner import _tz_get
from leewise.addons.http_routing.models.ir_http import unslug
...
class AppointmentController(http.Controller):
    ...
    def _appointments_base_domain(cls, filter_appointment_type_ids, search=False, invite_token=False, additional_domain=None):
        ...
        Returns:
            list: A list of domain expressions suitable for use in Leewise record filtering.
        """
