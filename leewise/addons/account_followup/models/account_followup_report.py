...
from leewise.tools.misc import formatLang, format_date, get_lang
from leewise.tools.translate import _
from leewise.tools import DEFAULT_SERVER_DATE_FORMAT, html2plaintext, plaintext2html
    ...
    def _send_email(self, options):
        ...
        for to_send_partner in followup_recipients:
            ...
            if email and email.strip():
                ...
                # Otherwise, if the follow-up is automatic, the author_id will default to LeewiseBot.
