...
from leewise.tools import DEFAULT_SERVER_DATETIME_FORMAT, get_lang
from leewise.tools.float_utils import float_compare, float_round
...
class PurchaseOrderLine(models.Model):
    ...
    def _get_product_catalog_lines_data(self):
        ...
        :raise leewise.exceptions.ValueError: ``len(self.product_id) != 1``
        :rtype: dict
