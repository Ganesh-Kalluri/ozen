...
from leewise.tools.misc import format_datetime
...
class SocialPostConvert2Lead(models.TransientModel):
    ...
    def _compute_partner_action_data(self):
        ...
        customer with the same name in your Leewise database -> do the matching.
    ...
    def _compute_utm_data(self):
        ...
        - If we find a matching social.post, we use its source and campaign
          ...
          social.post record related to that published content in your Leewise database, but it will
