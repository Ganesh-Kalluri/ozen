...
from leewise.addons.mail_group.tests.data import GROUP_TEMPLATE
from leewise.addons.mail_group.tests.common import TestMailListCommon
...
class TestMailGroupModeration(TestMailListCommon):
    ...
    @mute_logger('leewise.models.unlink', 'leewise.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('leewise.addons.base.models.ir_rule', 'leewise.addons.base.models.ir_model')
...
class TestModeration(TestMailListCommon):
    ...
    @mute_logger('leewise.addons.mail.models.mail_thread', 'leewise.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('leewise.addons.mail.models.mail_thread', 'leewise.addons.mail_group.models.mail_group_message', 'leewise.models.unlink')
    @users('employee')
    ...
    @mute_logger('leewise.addons.mail_group.models.mail_group')
    @users('employee')
