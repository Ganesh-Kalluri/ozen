...
from leewise.addons.account_auto_transfer.tests.account_auto_transfer_test_classes import AccountAutoTransferTestCase

from leewise import Command, fields
from leewise.models import UserError, ValidationError
...
class TransferModelTestCase(AccountAutoTransferTestCase):
    @patch('leewise.addons.account_auto_transfer.models.transfer_model.TransferModel.action_perform_auto_transfer')
    ...
    @patch('leewise.addons.account_auto_transfer.models.transfer_model.TransferModel._create_or_update_move_for_period')
    ...
    @patch('leewise.addons.account_auto_transfer.models.transfer_model.TransferModel._get_auto_transfer_move_line_values')
    ...
    @patch('leewise.addons.account_auto_transfer.models.transfer_model.TransferModel._get_non_analytic_transfer_values')
    ...
    @patch(
        'leewise.addons.account_auto_transfer.models.transfer_model.TransferModelLine._get_destination_account_transfer_move_line_values')
