...
class m(models.Model):
    ...
    def generate_redirect_warning(self):
        ...
        raise leewise.exceptions.RedirectWarning('description', action.id, 'Go to the redirection')

    def generate_access_denied(self):
        raise leewise.exceptions.AccessDenied()

    def generate_access_error(self):
        raise leewise.exceptions.AccessError('description')
    ...
    def generate_user_error(self):
        raise leewise.exceptions.UserError('description')

    def generate_missing_error(self):
        raise leewise.exceptions.MissingError('description')

    def generate_validation_error(self):
        raise leewise.exceptions.ValidationError('description')
