...
class TestMailingStatistics(TestMassMailCommon):
    ...
    @mute_logger('leewise.addons.mass_mailing.models.mailing', 'leewise.addons.mail.models.mail_mail', 'leewise.addons.mail.models.mail_thread')
    def test_mailing_statistics(self):
        ...
        self.gateway_mail_click(mailing, target_records[0], 'https://www.leewise.be')
        self.gateway_mail_click(mailing, target_records[2], 'https://www.leewise.be')
        self.gateway_mail_click(mailing, target_records[3], 'https://www.leewise.be')
