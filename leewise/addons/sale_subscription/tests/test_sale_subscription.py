...
from leewise.addons.sale_subscription.models.sale_order import SaleOrder
from leewise.tests import Form, tagged
from leewise.tools import mute_logger
from leewise import fields, Command
from leewise.exceptions import AccessError, ValidationError, UserError
...
class TestSubscription(TestSubscriptionCommon):
    ...
    def test_subscription_change_partner(self):
        ...
        with patch('leewise.addons.sale_subscription.models.sale_order.SaleOrder.action_confirm', _action_confirm_mock):
    ...
    def test_sale_subscription_post_invoice(self):
        ...
        with patch('leewise.addons.sale_subscription.models.sale_order_line.SaleOrderLine._reset_subscription_quantity_post_invoice', patched_reset), freeze_time("2021-01-01"):
            sub = self.subscription
            sub.action_confirm()
            self.env['sale.order']._cron_recurring_create_invoice()
