...
from leewise.addons.sale.controllers.portal import CustomerPortal as SaleCustomerPortal
from leewise.addons.sale_subscription.tests.test_sale_subscription import TestSubscriptionCommon
...
class TestSubscriptionPaymentFlows(TestSubscriptionCommon, PaymentHttpCommon):
    ...
    def test_tokenization_support_is_required(self):
        ...
        with MockRequest(self.env), patch(
            'leewise.addons.payment.models.payment_method.PaymentMethod'
    ...
    def _my_sub_assign_token(self, **values):
        ...
        with mute_logger('leewise.addons.base.models.ir_rule', 'leewise.http'):
    ...
    def test_transaction_route_rejects_unexpected_kwarg(self):
        ...
        with mute_logger("leewise.http"), self.assertRaises(
            JsonRpcException, msg='leewise.exceptions.ValidationError'
        ):
