...
# load_iot_handlers called by Manager.run, the log levels that get applied to the leewise
...
# be ERROR at the leewise-bin level. In order to work around this, it's possible to
...
class SocketInterface(Interface):
    ...
    def replace_socket_device(self, dev, addr):
        ...
        # problems since the key is also reported to the Leewise database, which means a
