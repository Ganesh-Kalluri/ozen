...

{
    ...
    'description': """
Import your Amazon orders in Leewise and synchronize deliveries
============================================================

Key Features
------------
* Import orders from multiple accounts and marketplaces.
* Orders are matched with Leewise products based on their internal reference (SKU in Amazon).
* Deliveries confirmed in Leewise are synchronized in Amazon.
