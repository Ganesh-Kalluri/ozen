...
from leewise.addons.appointment_hr.tests.common import AppointmentHrCommon
from leewise.addons.appointment.tests.test_performance import AppointmentPerformanceCase, AppointmentUIPerformanceCase
from leewise.tests import tagged, users
from leewise.tests.common import warmup
