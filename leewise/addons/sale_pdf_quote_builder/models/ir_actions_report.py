...
from leewise.tools import format_amount, format_date, format_datetime, pdf
...
class IrActionsReport(models.Model):
    ...
    def _get_form_fields_mapping(self, order, doc_line_id_mapping=None):
        """ Dictionary mapping specific pdf fields name to Leewise fields data for a sale order.
        Override this method to add new fields to the mapping.

        :param recordset order: sale.order record
        :rtype: dict
        :return: mapping of fields name to Leewise fields data
    ...
    def _get_sol_form_fields_mapping(self, line):
        """ Dictionary mapping specific pdf fields name to Leewise fields data for a sale order line.
        ...
        :rtype: dict
        :return: mapping of prefixed fields name to Leewise fields data
