...
from leewise.tools import float_compare, groupby
from leewise.tools.misc import unique
...
class ProductProduct(models.Model):
    ...
    def _unlink_or_archive(self, check_access=True):
        ...
        try:
            with self.env.cr.savepoint(), tools.mute_logger('leewise.sql_db'):
                self.unlink()
        except Exception:
    ...
    def copy(self, default=None):
        ...
        returned.
        """
        # copy variant is disabled in https://github.com/leewise/leewise/pull/38303
