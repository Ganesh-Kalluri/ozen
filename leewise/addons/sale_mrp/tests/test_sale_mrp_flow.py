...
from leewise.addons.stock_account.tests.test_anglo_saxon_valuation_reconciliation_common import ValuationReconciliationTestCommon
from leewise.tests import common, Form
from leewise.exceptions import UserError
from leewise.tools import mute_logger, float_compare
from leewise.addons.stock_account.tests.test_stockvaluation import _create_accounting_data
...
class TestSaleMrpFlow(TestSaleMrpFlowCommon):
    ...
    @mute_logger('leewise.tests.common.onchange')
