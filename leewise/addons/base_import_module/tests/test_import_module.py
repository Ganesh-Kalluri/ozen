...
from leewise.tests import new_test_user


from unittest.mock import patch

from leewise import release
from leewise.addons import __path__ as __addons_path__
from leewise.tools import mute_logger


@leewise.tests.tagged('post_install', '-at_install')
class TestImportModule(leewise.tests.TransactionCase):
    ...
    def test_import_zip_invalid_manifest(self):
        ...
        with mute_logger("leewise.addons.base_import_module.models.ir_module"):
    ...
    def test_import_zip_ignore_unexpected_data_extension(self):
        ...
        with self.assertLogs('leewise.addons.base_import_module.models.ir_module') as log_catcher:
            self.import_zipfile(files)
...
class TestImportModuleHttp(TestImportModule, leewise.tests.HttpCase):
