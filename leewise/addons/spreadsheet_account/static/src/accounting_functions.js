...
functionRegistry.add("LEEWISE.DEBIT", {
...
functionRegistry.add("LEEWISE.BALANCE", {
...
functionRegistry.add("LEEWISE.FISCALYEAR.START", {
...
functionRegistry.add("LEEWISE.FISCALYEAR.END", {
...
functionRegistry.add("LEEWISE.ACCOUNT.GROUP", {
