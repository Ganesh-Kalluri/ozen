...
from leewise.addons.l10n_cl_edi_stock.tests.common import TestL10nClEdiStockCommon
from leewise.addons.l10n_cl_edi.tests.common import _check_with_xsd_patch
