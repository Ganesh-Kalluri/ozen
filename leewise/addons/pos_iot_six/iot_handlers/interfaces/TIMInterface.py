...
if system() == 'Windows':
    ...
    DOWNLOAD_URL = 'https://nightly.leewise.com/master/posbox/iotbox/six-timapiv23_09_w.zip'
else:
    LIB_PATH = file_path('hw_drivers/iot_handlers/lib')
    LIB_EXTENSION = '_l.so'
    IMPORT_LIBRARY = ctypes.CDLL
    DOWNLOAD_URL = 'https://nightly.leewise.com/master/posbox/iotbox/six-timapiv23_09_l.zip'
