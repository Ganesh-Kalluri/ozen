...
from leewise.addons.calendar.controllers.main import CalendarController
...
class GoogleCalendarController(CalendarController):
    ...
    def google_calendar_sync_data(self, model, **kw):
        """ This route/function is called when we want to synchronize Leewise
            ...
            The dictionary may contains an url, to allow Leewise Client to redirect user on
        ...
        if model == 'calendar.event':
            ...
            # Checking that user have already accepted Leewise to access his calendar !
