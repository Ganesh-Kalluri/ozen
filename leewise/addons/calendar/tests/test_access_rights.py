...
class TestAccessRights(TransactionCase):
    ...
    @classmethod
    @mute_logger('leewise.tests', 'leewise.addons.auth_signup.models.res_users')
    def setUpClass(cls):
        super().setUpClass()
    ...
    def test_meeting_edit_access_notification_handle_in_leewise(self):
        # set notifications to "handle in Leewise" in Preferences for john, raoul, and george
        ...
        # this verifies that users with "handle in Leewise" notification setting can
