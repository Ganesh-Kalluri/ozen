...
from leewise.addons.marketing_automation.tests.common import MarketingAutomationCommon
...
class TestSyncing(SyncingCase):
    ...
    @mute_logger('leewise.addons.mass_mailing.models.mailing', 'leewise.tests')
