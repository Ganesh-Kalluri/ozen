...
from leewise.addons.base.tests.common import HttpCase
...
class TestWebsiteSaleTaxCloud(HttpCase):
    ...
    def test_recompute_taxes_before_payment(self):
        ...
        with \
                patch('leewise.addons.account_taxcloud.models.taxcloud_request.TaxCloudRequest.verify_address', self._verify_address),\
                patch('leewise.addons.account_taxcloud.models.taxcloud_request.TaxCloudRequest.get_all_taxes_values', self._get_all_taxes_values),\
