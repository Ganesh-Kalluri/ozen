...
from leewise.addons.sales_team.tests.common import TestSalesMC
from leewise.tests.common import users, TransactionCase
...
class TestCornerCases(TransactionCase):
    ...
    def test_unicity(self):
        ...
        with self.assertRaises(exceptions.UserError), mute_logger('leewise.sql_db'):
