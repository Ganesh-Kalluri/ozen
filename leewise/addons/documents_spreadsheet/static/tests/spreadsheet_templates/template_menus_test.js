                ...
                return Object.assign({}, actionMain, {
                    doAction: (actionRequest, options = {}) => {
                        if (
                            ...
                            assert.equal(
                                cells.A3.content,
                                `=LEEWISE.PIVOT.HEADER(1,"product_id",LEEWISE.PIVOT.POSITION(1,"product_id",1))`
                            );
                            assert.equal(
                                cells.B3.content,
                                `=LEEWISE.PIVOT(1,"probability","product_id",LEEWISE.PIVOT.POSITION(1,"product_id",1),"bar","false")`
                            );
