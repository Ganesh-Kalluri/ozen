...
from leewise.modules.module import _DEFAULT_MANIFEST, module_manifest, get_module_path
from leewise.tests import BaseCase
...
class ManifestLinter(BaseCase):
    ...
    def _load_manifest(self, module):
        """Do not rely on leewise/modules/module -> load_manifest
