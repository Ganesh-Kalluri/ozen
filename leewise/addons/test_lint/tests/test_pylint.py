...
from leewise.modules import get_modules, get_module_path
...
class TestPyLint(TransactionCase):
    ...
    def test_pylint(self):
        ...
        options = [
            ...
            '--load-plugins=pylint.extensions.bad_builtin,_leewise_checker_sql_injection,_leewise_checker_gettext,_leewise_checker_unlink_override',
