...
from leewise import _, api, fields, models, tools, SUPERUSER_ID
from leewise.tools import cleanup_xml_node
...
class AccountMoveSend(models.TransientModel):
    ...
    def _hook_invoice_document_after_pdf_report_render(self, invoice, invoice_data):
        ...
        reader = LeewisePdfFileReader(reader_buffer, strict=False)
