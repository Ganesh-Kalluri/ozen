...
class SocialTwitterCase(SocialCase):
    ...
    def test_no_duplicated_tweets_in_stream(self):
        ...
        with mute_logger('leewise.sql_db'):
    ...
    def test_tweet_post_message_counter(self):
        message_to_post = '''
            Leewise is a suite of business management software tools including,
            ...
            the framework and core ERP modules is curated by the Belgium-based Leewise
            Leewise is available for both on-premise and ready to use SaaS environment.
        '''
