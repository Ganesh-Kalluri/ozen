...
from leewise.tools import config, DEFAULT_SERVER_DATE_FORMAT, DEFAULT_SERVER_DATETIME_FORMAT, pycompat
...
class ImportMapping(models.Model):
    ...
    not match Leewise's field names or labels. This model is used
    ...
    def get_fields_tree(self, model, depth=FIELDS_RECURSION_LIMIT):
        ...
        .. class:: Field
            ...
            .. attribute:: name: str
                ...
                The field's logical (Leewise) name within the scope of
                its parent.
            ...
            .. attribute:: model_name: str
                ...
                Used in the Leewise Field Tooltip on the import view
