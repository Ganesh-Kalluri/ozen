...
from leewise import http, tools, _, release
from leewise.exceptions import UserError
from leewise.http import request
from leewise.tools import replace_exceptions
...
class LivechatController(http.Controller):
    ...
    @http.route('/im_livechat/leewise_ui_icons', type='http', auth='none', cors="*")
    def leewise_ui_icons(self, **kwargs):
        return http.Stream.from_path('web/static/lib/leewise_ui_icons/fonts/leewise_ui_icons.woff2').get_response()
