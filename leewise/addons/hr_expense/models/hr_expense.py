...
from leewise import api, fields, Command, models, _
from leewise.exceptions import UserError, ValidationError
from leewise.tools.misc import format_date
from leewise.tools import email_split, float_repr, float_round, is_html_empty
...
class HrExpense(models.Model):
    ...
    def _compute_currency_rate(self):
        """
            We want the default leewise rate when the following change:
