...
from leewise import api, models, fields, _, tools
from leewise.exceptions import UserError
from leewise.tools import pdf, float_repr
from leewise.tools.safe_eval import const_eval
...
class ProviderFedex(models.Model):
    ...
    fedex_weight_unit = fields.Selection([('LB', 'LB'),
                                          ('KG', 'KG')],
                                         default='LB')
    # Note about weight units: Leewise (v9) currently works with kilograms.
