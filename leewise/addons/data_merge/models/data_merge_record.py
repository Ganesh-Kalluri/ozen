...
from leewise.models import MAGIC_COLUMNS
from leewise.osv.expression import FALSE_DOMAIN, OR, expression
from leewise.tools import get_lang
from leewise.tools.misc import format_datetime, format_date, partition as tools_partition
