...
from leewise.addons.l10n_br_avatax.models.account_external_tax_mixin import AccountExternalTaxMixinL10nBR, IAP_SERVICE_NAME
...
class TestAvalaraBrCommon(AccountTestInvoicingCommon):
    ...
    def _setup_products(cls):
        ...
        cls.product_user_discount = cls.env['product.product'].create({
            'name': 'Leewise User Initial Discount',
            'list_price': -5.00,
            'standard_price': -5.00,
            **common,
        })
