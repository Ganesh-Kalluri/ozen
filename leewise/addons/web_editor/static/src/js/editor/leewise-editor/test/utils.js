...
import { LeewiseEditor } from '../src/LeewiseEditor.js';
...
export async function testEditor(Editor = LeewiseEditor, spec, options = {}) {
    hasMobileTest = false;
...
export const pasteLeewiseEditorHtml = async (editor, html) => pasteData(editor, html, 'text/leewise-editor');
...
export class BasicEditor extends LeewiseEditor {}
