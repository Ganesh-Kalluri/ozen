...
export class LeewiseEditor extends EventTarget {
    constructor(editable, options = {}) {
        ...
        this.options = defaultOptions(
            {
                ...
                // `convertNumericToUnit` as leewise-editor utils to avoid this
        ...
        this.editable.classList.add("leewise-editor-editable");
     ...
     * from outside the leewiseEditor.
     */
    ...
    _onClipboardCopy(clipboardEvent) {
        ...
        const leewiseHtml = dataHtmlElement.innerHTML;
        const leewiseText = selection.toString();
        clipboardEvent.clipboardData.setData('text/plain', leewiseText);
        clipboardEvent.clipboardData.setData('text/html', leewiseHtml);
        clipboardEvent.clipboardData.setData('text/leewise-editor', leewiseHtml);
    }
    /**
     * @private
     */
    ...
    isSelectionInBlockRoot() {
        ...
        while (
            ...
            !currentNode.classList.contains('leewise-editor-editable') &&
    ...
    _onPaste(ev) {
        ...
        const leewiseEditorHtml = ev.clipboardData.getData('text/leewise-editor');
        ...
        } else if (leewiseEditorHtml) {
            const fragment = parseHTML(this.document, leewiseEditorHtml);
