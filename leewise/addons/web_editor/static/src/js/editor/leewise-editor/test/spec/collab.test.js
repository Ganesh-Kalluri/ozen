...
import { LeewiseEditor, parseHTML, setSelection } from '../../src/LeewiseEditor.js';
import {
    insertCharsAt,
...
const testMultiEditor = async spec => {
    ...
    for (const clientInfo of clientInfosList) {
        ...
        let nextId = 1;
        LeewiseEditor.prototype._generateId = () => 'fake_id_' + nextId++;

        clientInfo.editor = new LeewiseEditor(clientInfo.editable, Object.assign({
            toSanitize: false,
    ...
    LeewiseEditor.prototype._generateId = () => 'fake_concurent_id_' + concurentNextId++;
