...
patch(Wysiwyg.prototype, {
    ...
    _loadIframe() {
        ...
        this.$editable = $('<div class="note-editable oe_structure leewise-editor-editable"></div>');
        this.$el.removeClass('note-editable oe_structure leewise-editor-editable');
        if (isEditableRoot) {
        ...
        var def = new Promise(function (resolve) {
            window.top[self._onUpdateIframeId] = function (_avoidDoubleLoad) {
                ...
                const $iframeWrapper = $('<div class="iframe-editor-wrapper leewise-editor">');
...
function getWysiwygIframeContent(params) {
    ...
    return `
        ...
        <script type="text/javascript">
            leewise.define('root.widget', ['@web/legacy/js/core/widget'], function (require) {
                'use strict';
    ...
    <body class="o_in_iframe">
        ...
        <script type="text/javascript">
            leewise.define('web_editor.wysiwyg.iniframe', [], function (require) {
                'use strict';
