...
export class LinkPopoverWidget {
    static createFor(params) {
        ...
        params.wysiwyg?.leewiseEditor.observerUnactive('LinkPopoverWidget');
        popoverWidget.start(); // This is not async
        params.wysiwyg?.leewiseEditor.observerActive('LinkPopoverWidget');
    ...
    start() {
        ...
        if (document !== this.wysiwyg.leewiseEditor.document) {
            $(this.wysiwyg.leewiseEditor.document).on('mouseup.link_popover', onClickDocument);
        }
    ...
    destroy() {
        ...
        $(this.wysiwyg.leewiseEditor.document).off('.link_popover');
