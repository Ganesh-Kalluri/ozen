...
import { deduceURLfromText } from "@web_editor/js/editor/leewise-editor/src/utils/sanitize";

const { getDeepRange, getInSelection, EMAIL_REGEX, PHONE_REGEX } = LeewiseEditorLib;
...
export class Link extends Component {
    ...
    async _updateState(props) {
        ...
        if (this.state.range) {
            this.$link = this.$link || $(LeewiseEditorLib.getInSelection(this.editable.ownerDocument, 'a'));
