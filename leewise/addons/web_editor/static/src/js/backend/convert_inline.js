...
import { getAdjacentPreviousSiblings, isBlock, rgbToHex, commonParentGet } from '../editor/leewise-editor/src/utils/utils';
...
export async function toInline($editable, cssRules, $iframe) {
    $editable.removeClass('leewise-editor-editable');
    const editable = $editable.get(0);
    ...
    $editable.addClass('leewise-editor-editable');
}
/**
...
function fontToImg($editable) {
    const editable = $editable.get(0);
    const { fonts } = leewise.loader.modules.get("@web_editor/js/wysiwyg/fonts");
