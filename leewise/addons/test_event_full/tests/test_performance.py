...
from leewise.addons.test_event_full.tests.common import TestEventFullCommon
from leewise.addons.website.tests.test_performance import UtilPerf
from leewise.tests.common import users, warmup, Form
...
class TestOnlineEventPerformance(EventPerformanceCase, UtilPerf):
    ...
    #                 'leewise.__DEBUG__.services["web_tour.tour"].run("wevent_performance_register")',
    #                 'leewise.__DEBUG__.services["web_tour.tour"].tours.wevent_performance_register.ready',
    #                 login=None,
    #                 timeout=200,
    #             )
