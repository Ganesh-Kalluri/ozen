...
from leewise.tools import exception_to_unicode
from leewise.tools.translate import _
from leewise.exceptions import MissingError, ValidationError
...
class EventMailScheduler(models.Model):
    ...
    configuration allowing to send emails on events since Leewise 9. A cron exists
