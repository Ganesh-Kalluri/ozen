...
import leewise
from leewise import fields, exceptions, Command
from leewise.tests import Form
from leewise.tests.common import TransactionCase, tagged
from leewise.addons.account.tests.common import AccountTestInvoicingCommon
from leewise.tools import DEFAULT_SERVER_DATETIME_FORMAT
...
class TestStockValuationWithCOA(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        old_action_post = leewise.addons.account.models.account_move.AccountMove.action_post
        old_create = leewise.models.BaseModel.create
        ...
        post_patch = patch('leewise.addons.account.models.account_move.AccountMove.action_post', new_action_post)
        create_patch = patch('leewise.models.BaseModel.create', new_create)
    ...
    def test_realtime_anglo_saxon_valuation_multicurrency_different_dates(self):
        ...
        def _today(*args, **kwargs):
            return date_po
        patchers = [
            patch('leewise.fields.Date.context_today', _today),
        ]
    ...
    def test_average_realtime_with_delivery_anglo_saxon_valuation_multicurrency_different_dates(self):
        ...
        patchers = [
            patch('leewise.fields.Date.context_today', _today),
            patch('leewise.fields.Datetime.now', _now),
        ]
