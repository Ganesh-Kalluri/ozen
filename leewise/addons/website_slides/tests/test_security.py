...
from leewise.addons.website_slides.tests import common
...
class TestAccess(common.SlidesCase):
    ...
    @mute_logger('leewise.models', 'leewise.addons.base.models.ir_rule')
...
class TestAccessFeatures(common.SlidesCase):
    ...
    @mute_logger('leewise.models.unlink', 'leewise.addons.base.models.ir_rule', 'leewise.addons.base.models.ir_model')
...
class TestReview(common.SlidesCase, HttpCase):
    ...
    def test_channel_multiple_reviews(self):
        ...
        self.assertIn("leewise.exceptions.ValidationError", res2.text)
