...
from leewise.addons.base.tests.common import HttpCaseWithUserPortal
from leewise.addons.gamification.tests.common import HttpCaseGamification
...
class TestUi(TestUICommon):
    ...
    @mute_logger("leewise.http", "leewise.addons.base.models.ir_rule", "werkzeug")
