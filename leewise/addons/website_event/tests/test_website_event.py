...
from leewise.addons.base.tests.common import HttpCaseWithUserDemo, HttpCaseWithUserPortal
from leewise.addons.mail.tests.common import mail_new_test_user
from leewise.addons.website.tests.test_base_url import TestUrlCommon
from leewise.addons.website_event.tests.common import TestEventOnlineCommon, OnlineEventCase
...
class TestEventRegisterUTM(HttpCase, TestEventOnlineCommon):
    def test_event_registration_utm_values(self):
        ...
        self.opener.cookies.update({
            'leewise_utm_campaign': event_campaign.name,
            'leewise_utm_source': self.env.ref('utm.utm_source_newsletter').name,
            'leewise_utm_medium': self.env.ref('utm.utm_medium_email').name
        })
