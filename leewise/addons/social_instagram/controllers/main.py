...
from leewise.addons.auth_oauth.controllers.main import fragment_to_query_string
from leewise.addons.social.controllers.main import SocialController
from leewise.addons.social.controllers.main import SocialValidationException
...
class SocialInstagramController(SocialController):
    ...
    def _instagram_create_accounts(self, access_token, extended_access_token):
        ...
        if accounts_to_create:
            ...
            message = _('You need to link your Instagram page to your Facebook account to post with Leewise Social.\n Please create one and make sure it is linked to your account.')
