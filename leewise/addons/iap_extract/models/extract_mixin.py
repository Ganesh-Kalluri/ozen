...
from leewise import api, fields, models, _lt, _
...
ERROR_MESSAGES = {
    ...
    'error_invalid_account_token': _lt(
        ...
        "Please delete it to let Leewise generate a new one or fill it with a valid token."),
...
class ExtractMixin(models.AbstractModel):
    ...
    def _check_ocr_status(self, force_write=False):
        ...
        if result['status'] == 'success':
            ...
            # Set LeewiseBot as the author of the tracking message
