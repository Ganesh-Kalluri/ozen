...
from leewise.addons.crm.tests.test_crm_lead_assignment import TestLeadAssignCommon
...
class TestLeadAssignPerf(TestLeadAssignCommon):
    ...
    @mute_logger('leewise.models.unlink', 'leewise.addons.crm.models.crm_team', 'leewise.addons.crm.models.crm_team_member')
