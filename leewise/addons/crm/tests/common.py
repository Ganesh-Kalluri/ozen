...
from leewise.addons.crm.models.crm_lead import PARTNER_ADDRESS_FIELDS_TO_SYNC
from leewise.addons.mail.tests.common import MailCase, mail_new_test_user
from leewise.addons.phone_validation.tools import phone_validation
from leewise.addons.sales_team.tests.common import TestSalesCommon
from leewise.fields import Datetime
from leewise import models, tools
...
class TestLeadConvertCommon(TestCrmCommon):
    ...
    def setUpClass(cls):
        ...
        cls.crm_lead_dt_patcher = patch('leewise.addons.crm.models.crm_lead.fields.Datetime', wraps=Datetime)
