...
from leewise import api, fields, models, tools, SUPERUSER_ID
from leewise.addons.iap.tools import iap_tools
from leewise.addons.mail.tools import mail_validation
...
from leewise.tools import date_utils, email_split, is_html_empty, groupby, parse_contact_from_email
...
PLS_COMPUTE_BATCH_STEP = 50000  # leewise.models.PREFETCH_MAX = 1000 but larger cluster can speed up global computation
