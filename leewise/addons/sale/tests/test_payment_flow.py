...
from leewise.tests import tagged, JsonRpcException
from leewise.tools import mute_logger

from leewise.addons.account_payment.tests.common import AccountPaymentCommon
from leewise.addons.payment.tests.http_common import PaymentHttpCommon
from leewise.addons.portal.controllers.portal import CustomerPortal
from leewise.addons.sale.controllers.portal import PaymentPortal
...
class TestSalePayment(AccountPaymentCommon, SaleCommon, PaymentHttpCommon):
    ...
    def test_11_so_payment_link(self):
        ...
        with patch(
            'leewise.addons.payment.controllers.portal.PaymentPortal'
        ...
        with mute_logger('leewise.addons.payment.models.payment_transaction'):
    ...
    def test_invoice_is_final(self):
        ...
        with mute_logger('leewise.addons.sale.models.payment_transaction'), patch(
            'leewise.addons.sale.models.sale_order.SaleOrder._create_invoices',
    ...
    def test_check_payment_access_token_before_rerouting_flow(self):
        ...
        ), patch('leewise.addons.payment.utils.check_access_token') as check_payment_access_token_mock:
            try:
                payment_portal_controller._get_extra_payment_form_values(
                    sale_order_id=self.sale_order.id, access_token='whatever'
                )
    ...
    def test_transaction_route_rejects_unexpected_kwarg(self):
        ...
        with self.assertRaises(JsonRpcException, msg='leewise.exceptions.ValidationError'):
