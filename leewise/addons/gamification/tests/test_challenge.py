...
from leewise.addons.gamification.tests.common import TransactionCaseGamification
...
class test_challenge(TestGamificationCommon):
    ...
    @mute_logger('leewise.models.unlink', 'leewise.addons.mail', 'leewise.addons.auth_signup')
