...
from leewise.modules.module import get_module_root, MANIFEST_NAMES
from leewise.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """ Quickly start the leewise server with default options """
    ...
    def run(self, cmdargs):
        ...
        try:
            ...
            leewise.tools.config['init']['base'] = True
